...
class function TfrmDefaultCadastro.alterar(Sender: TfrmDefaultCadastroClass; ACampoChave: String; ACampoChaveValor: Variant): TRetornoCadastro;
var
  iFormCadastro: TfrmDefaultCadastro;
begin
  if Sender = Nil then
...
class function TfrmDefaultCadastro.excluir(Sender: TfrmDefaultCadastroClass; ACampoChave: String; ACampoChaveValor: Variant): TRetornoCadastro;
var
  iFormCadastro: TfrmDefaultCadastro;
begin
  if Sender = Nil then
