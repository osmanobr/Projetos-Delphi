    ...
    <section id="why-us" class="why-us">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 align-items-stretch video-box aos-init" style="background-image: url(&quot;assets/img/bg-video-anexo.webp&quot;); background-position-x: inherit;" data-aos="fade-right">
            <a data-href="https://youtu.be/d-t4AS9qyQ8" role="button" class="venobox play-btn mb-4 vbox-item" data-vbtype="video" data-autoplay="true"></a>
          </div>



          <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch aos-init" data-aos="fade-left">

            <div class="content text-center">
              <h3>- PREPARAMOS UM SÉRIE ESPECIAL -<strong>PLANO DE RETOMADA COVID-19</strong></h3>
              <p>
                Cadastre-se agora e assista essa série com dicas valisosas para o seu negócio.
              </p>
            </div>
            ...
            .why-us .content {
                padding: 14px 100px 0 100px!important;
            }
			...
			O campo é obrigatório
						...
						sc
					</option></select> <span class="b24-form-sign-text">Fornecido por</span> <span class="b24-form-sign-bx">Bitrix</span> <span class="b24-form-sign-24">24</span></div></div></div></div><script data-b24-form="inline/5/6gdolw" data-skip-moving="true" data-b24-loaded="true"> (function(w,d,u){ var s=d.createElement('script');s.async=true;s.src=u+'?'+(Date.now()/180000|0); var h=d.getElementsByTagName('script')[0];h.parentNode.insertBefore(s,h); })(window,document,'https://cdn.bitrix24.com.br/b17850427/crm/form/loader_5.js'); </script>
