...
begin
//  EdtTokenBot.Text := 'SUA API TOKEN AQUI';

  // use o botão "getUpdates" para obter IDs de chats (apenas mensagens enviadas ao seu bot)
 // EdtUserId.Text := 'ID DO USUÁRIO PARA ENVIAR MENSAGENS';
