...
uses
  ...
  ModelBase, ModelBaseList, Model.ERP.acerto, DalBaseCRUD,
  SQLQuery;

type
  TDalERPacerto = class(TDalBaseCRUD)
  private 
...
function TDalERPacerto.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPacerto );              
...
function TDalERPacerto.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(acerto_almoxarifado).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPacerto.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(acerto_almoxarifado);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPacerto.Create ); 
...
begin                                                                    
  ...
  SQL.Update(acerto_almoxarifado);
