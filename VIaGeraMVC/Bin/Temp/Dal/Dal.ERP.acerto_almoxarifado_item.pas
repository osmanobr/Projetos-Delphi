...
unit Dal.ERP.acerto_almoxarifado;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.acerto_almoxarifado, DalBaseCRUD,
  SQLQuery;

type
  TDalERPacertoalmoxarifado = class(TDalBaseCRUD)
  private 
...
function TDalERPacertoalmoxarifado.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPacertoalmoxarifado );              
...
function TDalERPacertoalmoxarifado.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(acerto_almoxarifado_item).Fields( Self.FModel.ToString ).Values; 
     SQL.Field(Self.FModel.id).Next;
     SQL.Field(Self.FModel.id_empresa).Next;
     SQL.Field(Self.FModel.id_acerto_almoxarifado).Next;
...
function TDalERPacertoalmoxarifado.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(acerto_almoxarifado_item);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPacertoalmoxarifado.Create ); 
      Self.FModelList[I].id      := SQL.getInteger(id);
      Self.FModelList[I].id_empresa      := SQL.getInteger(id_empresa);
      Self.FModelList[I].id_acerto_almoxarifado      := SQL.getInteger(id_acerto_almoxarifado);
...
begin                                                                    
  ...
  SQL.Update(acerto_almoxarifado_item);
