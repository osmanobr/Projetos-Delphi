...
unit Dal.ERP.acerto_insumo;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.acerto_insumo, DalBaseCRUD,
  SQLQuery;

type
  TDalERPacertoinsumo = class(TDalBaseCRUD)
  private 
...
function TDalERPacertoinsumo.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPacertoinsumo );              
...
function TDalERPacertoinsumo.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(acerto_insumo_item).Fields( Self.FModel.ToString ).Values; 
     SQL.Field(Self.FModel.id).Next;
     SQL.Field(Self.FModel.id_empresa).Next;
     SQL.Field(Self.FModel.id_acerto_insumo).Next;
...
function TDalERPacertoinsumo.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(acerto_insumo_item);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPacertoinsumo.Create ); 
      Self.FModelList[I].id      := SQL.getInteger(id);
      Self.FModelList[I].id_empresa      := SQL.getInteger(id_empresa);
      Self.FModelList[I].id_acerto_insumo      := SQL.getInteger(id_acerto_insumo);
