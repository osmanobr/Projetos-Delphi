...
unit Dal.ERP.acerto_insumo_item;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.acerto_insumo_item, DalBaseCRUD,
  SQLQuery;

type
  TDalERPacertoinsumoitem = class(TDalBaseCRUD)
  private 
...
function TDalERPacertoinsumoitem.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPacertoinsumoitem );              
...
function TDalERPacertoinsumoitem.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(acerto_item).Fields( Self.FModel.ToString ).Values; 
     SQL.Field(Self.FModel.id).Next;
     SQL.Field(Self.FModel.id_empresa).Next;
     SQL.Field(Self.FModel.id_acerto).Next;
...
function TDalERPacertoinsumoitem.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPacertoinsumoitem.Create ); 
      Self.FModelList[I].id      := SQL.getInteger(id);
      Self.FModelList[I].id_empresa      := SQL.getInteger(id_empresa);
      Self.FModelList[I].id_acerto      := SQL.getInteger(id_acerto);
