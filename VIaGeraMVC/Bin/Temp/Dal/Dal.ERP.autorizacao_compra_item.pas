...
unit Dal.ERP.autorizacao_compra;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.autorizacao_compra, DalBaseCRUD,
  SQLQuery;

type
  TDalERPautorizacaocompra = class(TDalBaseCRUD)
  private 
...
function TDalERPautorizacaocompra.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPautorizacaocompra );              
...
function TDalERPautorizacaocompra.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(autorizacao_compra_item).Fields( Self.FModel.ToString ).Values; 
     SQL.Field(Self.FModel.id).Next;
     SQL.Field(Self.FModel.id_empresa).Next;
     SQL.Field(Self.FModel.id_autorizacao).Next;
...
function TDalERPautorizacaocompra.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(autorizacao_compra_item);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPautorizacaocompra.Create ); 
      Self.FModelList[I].id      := SQL.getInteger(id);
      Self.FModelList[I].id_empresa      := SQL.getInteger(id_empresa);
      Self.FModelList[I].id_autorizacao      := SQL.getInteger(id_autorizacao);
...
begin                                                                    
  ...
  SQL.Update(autorizacao_compra_item);
