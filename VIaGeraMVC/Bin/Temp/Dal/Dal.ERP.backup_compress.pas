...
uses
  ...
  ModelBase, ModelBaseList, Model.ERP.backup, DalBaseCRUD,
  SQLQuery;

type
  TDalERPbackup = class(TDalBaseCRUD)
  private 
...
function TDalERPbackup.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPbackup );              
...
function TDalERPbackup.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(backup_compress).Fields( Self.FModel.ToString ).Values; 
     SQL.Field(Self.FModel.id).Next;
     SQL.Field(Self.FModel.id_backup).Next;
...
function TDalERPbackup.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(backup_compress);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPbackup.Create ); 
      Self.FModelList[I].id      := SQL.getInteger(id);
      Self.FModelList[I].id_backup      := SQL.getInteger(id_backup);
