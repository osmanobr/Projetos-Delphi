...
unit Dal.ERP.balanco;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.balanco, DalBaseCRUD,
  SQLQuery;

type
  TDalERPbalanco = class(TDalBaseCRUD)
  private 
...
function TDalERPbalanco.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPbalanco );              
...
function TDalERPbalanco.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(balanco_item).Fields( Self.FModel.ToString ).Values; 
     ...
     SQL.Field(Self.FModel.usuario_lancamento).Next;
     SQL.Field(Self.FModel.usuario_fechamento).Next;
  dbInsert;
  Result := (ListError.Count = 0); 
end; 

function TDalERPbalanco.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPbalanco.Create ); 
      ...
      Self.FModelList[I].usuario_lancamento      := SQL.getInteger(usuario_lancamento);
      Self.FModelList[I].usuario_fechamento      := SQL.getInteger(usuario_fechamento);
      SQL.DataSet.Next;
    end;               
