...
unit Dal.ERP.balanco_item;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.balanco_item, DalBaseCRUD,
  SQLQuery;

type
  TDalERPbalancoitem = class(TDalBaseCRUD)
  private 
...
function TDalERPbalancoitem.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPbalancoitem );              
...
function TDalERPbalancoitem.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(balanco_uniao).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPbalancoitem.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPbalancoitem.Create ); 
