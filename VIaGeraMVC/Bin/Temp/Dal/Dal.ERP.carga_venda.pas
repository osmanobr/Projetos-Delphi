...
unit Dal.ERP.carga_pdv_historico;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.carga_pdv_historico, DalBaseCRUD,
  SQLQuery;

type
  TDalERPcargapdvhistorico = class(TDalBaseCRUD)
  private 
...
function TDalERPcargapdvhistorico.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPcargapdvhistorico );              
...
function TDalERPcargapdvhistorico.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(carga_venda).Fields( Self.FModel.ToString ).Values; 
     ...
     SQL.Field(Self.FModel.cobranca).Next;
...
function TDalERPcargapdvhistorico.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPcargapdvhistorico.Create ); 
      ...
      Self.FModelList[I].cobranca      := SQL.getInteger(cobranca);
