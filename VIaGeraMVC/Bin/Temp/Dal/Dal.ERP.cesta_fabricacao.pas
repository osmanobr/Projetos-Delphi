...
uses
  ...
  ModelBase, ModelBaseList, Model.ERP.cesta, DalBaseCRUD,
  SQLQuery;

type
  TDalERPcesta = class(TDalBaseCRUD)
  private 
...
function TDalERPcesta.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPcesta );              
...
function TDalERPcesta.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(cesta_fabricacao).Fields( Self.FModel.ToString ).Values; 
     SQL.Field(Self.FModel.id).Next;
     SQL.Field(Self.FModel.id_empresa).Next;
     SQL.Field(Self.FModel.id_fabricante).Next;
     SQL.Field(Self.FModel.id_cesta).Next;
...
function TDalERPcesta.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(cesta_fabricacao);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPcesta.Create ); 
      Self.FModelList[I].id      := SQL.getInteger(id);
      Self.FModelList[I].id_empresa      := SQL.getInteger(id_empresa);
      Self.FModelList[I].id_fabricante      := SQL.getInteger(id_fabricante);
      Self.FModelList[I].id_cesta      := SQL.getInteger(id_cesta);
