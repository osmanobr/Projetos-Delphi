...
unit Dal.ERP.cfop_import;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.cfop_import, DalBaseCRUD,
  SQLQuery;

type
  TDalERPcfopimport = class(TDalBaseCRUD)
  private 
...
function TDalERPcfopimport.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPcfopimport );              
...
function TDalERPcfopimport.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(change_log).Fields( Self.FModel.ToString ).Values; 
     SQL.Field(Self.FModel.id).Next;
     SQL.Field(Self.FModel.titulo).Next;
     SQL.Field(Self.FModel.descricao).Next;
     SQL.Field(Self.FModel.desenvolvedor).Next;
...
function TDalERPcfopimport.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPcfopimport.Create ); 
      Self.FModelList[I].id      := SQL.getInteger(id);
      Self.FModelList[I].titulo      := SQL.getInteger(titulo);
      Self.FModelList[I].descricao      := SQL.getInteger(descricao);
      Self.FModelList[I].desenvolvedor      := SQL.getInteger(desenvolvedor);
