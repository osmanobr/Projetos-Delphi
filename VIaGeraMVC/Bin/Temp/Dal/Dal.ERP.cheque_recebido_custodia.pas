...
unit Dal.ERP.cheque_recebido;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.cheque_recebido, DalBaseCRUD,
  SQLQuery;

type
  TDalERPchequerecebido = class(TDalBaseCRUD)
  private 
...
function TDalERPchequerecebido.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPchequerecebido );              
...
function TDalERPchequerecebido.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(cheque_recebido_custodia).Fields( Self.FModel.ToString ).Values; 
     ...
     SQL.Field(Self.FModel.titulos).Next;
     SQL.Field(Self.FModel.cheques).Next;
     SQL.Field(Self.FModel.dinheiro).Next;
     SQL.Field(Self.FModel.obs).Next;
  dbInsert;
  Result := (ListError.Count = 0); 
end; 

function TDalERPchequerecebido.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(cheque_recebido_custodia);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPchequerecebido.Create ); 
      ...
      Self.FModelList[I].titulos      := SQL.getInteger(titulos);
      Self.FModelList[I].cheques      := SQL.getInteger(cheques);
      Self.FModelList[I].dinheiro      := SQL.getInteger(dinheiro);
...
begin                                                                    
  ...
  SQL.Update(cheque_recebido_custodia);
