...
unit Dal.ERP.clientes_credito;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.clientes_credito, DalBaseCRUD,
  SQLQuery;

type
  TDalERPclientescredito = class(TDalBaseCRUD)
  private 
...
function TDalERPclientescredito.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPclientescredito );              
...
function TDalERPclientescredito.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(clientes_documentos).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPclientescredito.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(clientes_documentos);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPclientescredito.Create ); 
