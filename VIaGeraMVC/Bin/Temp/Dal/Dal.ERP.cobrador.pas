...
unit Dal.ERP.clientes_spc;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.clientes_spc, DalBaseCRUD,
  SQLQuery;

type
  TDalERPclientesspc = class(TDalBaseCRUD)
  private 
...
function TDalERPclientesspc.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPclientesspc );              
...
function TDalERPclientesspc.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(cobrador).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPclientesspc.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPclientesspc.Create ); 
