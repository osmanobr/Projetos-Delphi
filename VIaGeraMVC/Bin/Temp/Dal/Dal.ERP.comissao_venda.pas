...
unit Dal.ERP.comissao_os_servico;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.comissao_os_servico, DalBaseCRUD,
  SQLQuery;

type
  TDalERPcomissaoosservico = class(TDalBaseCRUD)
  private 
...
function TDalERPcomissaoosservico.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPcomissaoosservico );              
...
function TDalERPcomissaoosservico.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(comissao_venda).Fields( Self.FModel.ToString ).Values; 
     ...
     SQL.Field(Self.FModel.vl_promocao).Next;
  dbInsert;
  Result := (ListError.Count = 0); 
end; 

function TDalERPcomissaoosservico.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPcomissaoosservico.Create ); 
      ...
      Self.FModelList[I].vl_promocao      := SQL.getInteger(vl_promocao);
      SQL.DataSet.Next;
    end;               
