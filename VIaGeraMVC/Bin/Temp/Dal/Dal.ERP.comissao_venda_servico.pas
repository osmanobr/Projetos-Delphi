...
unit Dal.ERP.comissao_venda_produto;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.comissao_venda_produto, DalBaseCRUD,
  SQLQuery;

type
  TDalERPcomissaovendaproduto = class(TDalBaseCRUD)
  private 
...
function TDalERPcomissaovendaproduto.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPcomissaovendaproduto );              
...
function TDalERPcomissaovendaproduto.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(comissao_venda_servico).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPcomissaovendaproduto.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(comissao_venda_servico);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPcomissaovendaproduto.Create ); 
...
begin                                                                    
  ...
  SQL.Update(comissao_venda_servico);
