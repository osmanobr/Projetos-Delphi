...
unit Dal.ERP.consignado;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.consignado, DalBaseCRUD,
  SQLQuery;

type
  TDalERPconsignado = class(TDalBaseCRUD)
  private 
...
function TDalERPconsignado.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPconsignado );              
...
function TDalERPconsignado.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(consignado_item).Fields( Self.FModel.ToString ).Values; 
     SQL.Field(Self.FModel.id).Next;
     SQL.Field(Self.FModel.id_consignado).Next;
...
function TDalERPconsignado.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(consignado_item);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPconsignado.Create ); 
      Self.FModelList[I].id      := SQL.getInteger(id);
      Self.FModelList[I].id_consignado      := SQL.getInteger(id_consignado);
