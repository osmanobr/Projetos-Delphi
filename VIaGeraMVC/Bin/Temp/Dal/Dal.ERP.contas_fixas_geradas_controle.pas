...
unit Dal.ERP.contas_fixas;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.contas_fixas, DalBaseCRUD,
  SQLQuery;

type
  TDalERPcontasfixas = class(TDalBaseCRUD)
  private 
...
function TDalERPcontasfixas.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPcontasfixas );              
...
function TDalERPcontasfixas.Insert(Model: TModelBase): Boolean; 
...
function TDalERPcontasfixas.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(contas_fixas_geradas_controle);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPcontasfixas.Create ); 
      ...
      Self.FModelList[I].data_gerado      := SQL.getInteger(data_gerado);
...
begin                                                                    
  ...
  SQL.Update(contas_fixas_geradas_controle);
