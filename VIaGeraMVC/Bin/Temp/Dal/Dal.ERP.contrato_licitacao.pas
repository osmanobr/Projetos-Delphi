...
unit Dal.ERP.contrato_cliente;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.contrato_cliente, DalBaseCRUD,
  SQLQuery;

type
  TDalERPcontratocliente = class(TDalBaseCRUD)
  private 
...
function TDalERPcontratocliente.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPcontratocliente );              
...
function TDalERPcontratocliente.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(contrato_licitacao).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPcontratocliente.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(contrato_licitacao);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPcontratocliente.Create ); 
