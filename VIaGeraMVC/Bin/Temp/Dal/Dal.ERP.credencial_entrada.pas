...
unit Dal.ERP.credencial_classe;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.credencial_classe, DalBaseCRUD,
  SQLQuery;

type
  TDalERPcredencialclasse = class(TDalBaseCRUD)
  private 
...
function TDalERPcredencialclasse.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPcredencialclasse );              
...
function TDalERPcredencialclasse.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(credencial_entrada).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPcredencialclasse.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(credencial_entrada);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPcredencialclasse.Create ); 
