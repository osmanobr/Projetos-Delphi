...
unit Dal.ERP.estimativa_obra_historico;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.estimativa_obra_historico, DalBaseCRUD,
  SQLQuery;

type
  TDalERPestimativaobrahistorico = class(TDalBaseCRUD)
  private 
...
function TDalERPestimativaobrahistorico.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPestimativaobrahistorico );              
...
function TDalERPestimativaobrahistorico.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(estimativa_obra_item).Fields( Self.FModel.ToString ).Values; 
     ...
     SQL.Field(Self.FModel.concluido).Next;
     SQL.Field(Self.FModel.custo).Next;
  dbInsert;
  Result := (ListError.Count = 0); 
end; 

function TDalERPestimativaobrahistorico.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(estimativa_obra_item);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPestimativaobrahistorico.Create ); 
      ...
      Self.FModelList[I].concluido      := SQL.getInteger(concluido);
...
begin                                                                    
  ...
  SQL.Update(estimativa_obra_item);
