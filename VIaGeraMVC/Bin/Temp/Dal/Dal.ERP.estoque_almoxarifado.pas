...
unit Dal.ERP.estoque;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.estoque, DalBaseCRUD,
  SQLQuery;

type
  TDalERPestoque = class(TDalBaseCRUD)
  private 
...
function TDalERPestoque.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPestoque );              
...
function TDalERPestoque.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(estoque_almoxarifado).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPestoque.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(estoque_almoxarifado);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPestoque.Create ); 
...
begin                                                                    
  ...
  SQL.Update(estoque_almoxarifado);
