...
unit Dal.ERP.estoque_terceiro;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.estoque_terceiro, DalBaseCRUD,
  SQLQuery;

type
  TDalERPestoqueterceiro = class(TDalBaseCRUD)
  private 
...
function TDalERPestoqueterceiro.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPestoqueterceiro );              
...
function TDalERPestoqueterceiro.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(estoque_vendedor).Fields( Self.FModel.ToString ).Values; 
     ...
     SQL.Field(Self.FModel.qtd_carga).Next;
     SQL.Field(Self.FModel.qtd_venda).Next;
     SQL.Field(Self.FModel.qtd_devolucao).Next;
...
function TDalERPestoqueterceiro.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(estoque_vendedor);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPestoqueterceiro.Create ); 
      ...
      Self.FModelList[I].qtd_carga      := SQL.getInteger(qtd_carga);
      Self.FModelList[I].qtd_venda      := SQL.getInteger(qtd_venda);
      Self.FModelList[I].qtd_devolucao      := SQL.getInteger(qtd_devolucao);
