...
unit Dal.ERP.familia;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.familia, DalBaseCRUD,
  SQLQuery;

type
  TDalERPfamilia = class(TDalBaseCRUD)
  private 
...
function TDalERPfamilia.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPfamilia );              
...
function TDalERPfamilia.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(fechamento_caixa).Fields( Self.FModel.ToString ).Values; 
     SQL.Field(Self.FModel.id).Next;
     SQL.Field(Self.FModel.id_empresa).Next;
     SQL.Field(Self.FModel.id_caixa).Next;
     SQL.Field(Self.FModel.movimento).Next;
...
function TDalERPfamilia.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(fechamento_caixa);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPfamilia.Create ); 
      Self.FModelList[I].id      := SQL.getInteger(id);
      Self.FModelList[I].id_empresa      := SQL.getInteger(id_empresa);
      Self.FModelList[I].id_caixa      := SQL.getInteger(id_caixa);
      Self.FModelList[I].movimento      := SQL.getInteger(movimento);
