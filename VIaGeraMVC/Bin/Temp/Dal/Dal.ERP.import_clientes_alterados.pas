...
unit Dal.ERP.import_clientes;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.import_clientes, DalBaseCRUD,
  SQLQuery;

type
  TDalERPimportclientes = class(TDalBaseCRUD)
  private 
...
function TDalERPimportclientes.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPimportclientes );              
...
function TDalERPimportclientes.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(import_clientes_alterados).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPimportclientes.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(import_clientes_alterados);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPimportclientes.Create ); 
...
begin                                                                    
  ...
  SQL.Update(import_clientes_alterados);
