...
unit Dal.ERP.import_kit;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.import_kit, DalBaseCRUD,
  SQLQuery;

type
  TDalERPimportkit = class(TDalBaseCRUD)
  private 
...
function TDalERPimportkit.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPimportkit );              
...
function TDalERPimportkit.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(import_produtos).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPimportkit.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(import_produtos);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPimportkit.Create ); 
