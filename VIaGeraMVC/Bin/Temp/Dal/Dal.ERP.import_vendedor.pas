...
unit Dal.ERP.import_produtos_grupos;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.import_produtos_grupos, DalBaseCRUD,
  SQLQuery;

type
  TDalERPimportprodutosgrupos = class(TDalBaseCRUD)
  private 
...
function TDalERPimportprodutosgrupos.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPimportprodutosgrupos );              
...
function TDalERPimportprodutosgrupos.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(import_vendedor).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPimportprodutosgrupos.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(import_vendedor);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPimportprodutosgrupos.Create ); 
