...
unit Dal.ERP.impressora;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.impressora, DalBaseCRUD,
  SQLQuery;

type
  TDalERPimpressora = class(TDalBaseCRUD)
  private 
...
function TDalERPimpressora.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPimpressora );              
...
function TDalERPimpressora.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(impressora_fiscal).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPimpressora.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(impressora_fiscal);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPimpressora.Create ); 
