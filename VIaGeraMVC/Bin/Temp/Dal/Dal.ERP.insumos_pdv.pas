...
unit Dal.ERP.insumos;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.insumos, DalBaseCRUD,
  SQLQuery;

type
  TDalERPinsumos = class(TDalBaseCRUD)
  private 
...
function TDalERPinsumos.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPinsumos );              
...
function TDalERPinsumos.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(insumos_pdv).Fields( Self.FModel.ToString ).Values; 
     ...
     SQL.Field(Self.FModel.id_princial).Next;
  dbInsert;
  Result := (ListError.Count = 0); 
end; 

function TDalERPinsumos.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPinsumos.Create ); 
      ...
      Self.FModelList[I].id_princial      := SQL.getInteger(id_princial);
      SQL.DataSet.Next;
    end;               
