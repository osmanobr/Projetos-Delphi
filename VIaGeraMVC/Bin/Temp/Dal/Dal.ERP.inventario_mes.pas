...
unit Dal.ERP.inventario;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.inventario, DalBaseCRUD,
  SQLQuery;

type
  TDalERPinventario = class(TDalBaseCRUD)
  private 
...
function TDalERPinventario.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPinventario );              
...
function TDalERPinventario.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(inventario_mes).Fields( Self.FModel.ToString ).Values; 
     ...
     SQL.Field(Self.FModel.mes).Next;
...
function TDalERPinventario.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPinventario.Create ); 
      ...
      Self.FModelList[I].mes      := SQL.getInteger(mes);
