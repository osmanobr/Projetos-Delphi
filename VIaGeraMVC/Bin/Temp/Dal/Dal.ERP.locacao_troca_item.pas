...
unit Dal.ERP.locacao_troca;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.locacao_troca, DalBaseCRUD,
  SQLQuery;

type
  TDalERPlocacaotroca = class(TDalBaseCRUD)
  private 
...
function TDalERPlocacaotroca.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPlocacaotroca );              
...
function TDalERPlocacaotroca.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(locacao_troca_item).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPlocacaotroca.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(locacao_troca_item);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPlocacaotroca.Create ); 
