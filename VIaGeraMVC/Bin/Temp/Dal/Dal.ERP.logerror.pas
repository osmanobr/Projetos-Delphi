...
uses
  ...
  ModelBase, ModelBaseList, Model.ERP.log, DalBaseCRUD,
  SQLQuery;

type
  TDalERPlog = class(TDalBaseCRUD)
  private 
    FModel : TModelERPlog;  
...
function TDalERPlog.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPlog );              
...
function TDalERPlog.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(logerror).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPlog.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPlog.Create ); 
