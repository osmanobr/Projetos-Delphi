...
unit Dal.ERP.mapa_resumo;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.mapa_resumo, DalBaseCRUD,
  SQLQuery;

type
  TDalERPmaparesumo = class(TDalBaseCRUD)
  private 
...
function TDalERPmaparesumo.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPmaparesumo );              
...
function TDalERPmaparesumo.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(maquinas_agricolas).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPmaparesumo.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(maquinas_agricolas);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPmaparesumo.Create ); 
