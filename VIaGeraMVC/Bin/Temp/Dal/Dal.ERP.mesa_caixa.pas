...
uses
  ...
  ModelBase, ModelBaseList, Model.ERP.mesa, DalBaseCRUD,
  SQLQuery;

type
  TDalERPmesa = class(TDalBaseCRUD)
  private 
...
function TDalERPmesa.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPmesa );              
...
function TDalERPmesa.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(mesa_caixa).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPmesa.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPmesa.Create ); 
