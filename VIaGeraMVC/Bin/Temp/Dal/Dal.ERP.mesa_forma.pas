...
unit Dal.ERP.mesa_cancelada;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.mesa_cancelada, DalBaseCRUD,
  SQLQuery;

type
  TDalERPmesacancelada = class(TDalBaseCRUD)
  private 
...
function TDalERPmesacancelada.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPmesacancelada );              
...
function TDalERPmesacancelada.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(mesa_forma).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPmesacancelada.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPmesacancelada.Create ); 
