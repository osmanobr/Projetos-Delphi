...
unit Dal.ERP.mesa_forma;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.mesa_forma, DalBaseCRUD,
  SQLQuery;

type
  TDalERPmesaforma = class(TDalBaseCRUD)
  private 
...
function TDalERPmesaforma.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPmesaforma );              
...
function TDalERPmesaforma.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(mesa_haver).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPmesaforma.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPmesaforma.Create ); 
