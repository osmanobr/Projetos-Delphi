...
unit Dal.ERP.mesa_item;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.mesa_item, DalBaseCRUD,
  SQLQuery;

type
  TDalERPmesaitem = class(TDalBaseCRUD)
  private 
...
function TDalERPmesaitem.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPmesaitem );              
...
function TDalERPmesaitem.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(mesa_lancamento).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPmesaitem.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(mesa_lancamento);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPmesaitem.Create ); 
