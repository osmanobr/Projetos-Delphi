...
unit Dal.ERP.motorista_documentos;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.motorista_documentos, DalBaseCRUD,
  SQLQuery;

type
  TDalERPmotoristadocumentos = class(TDalBaseCRUD)
  private 
...
function TDalERPmotoristadocumentos.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPmotoristadocumentos );              
...
function TDalERPmotoristadocumentos.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(movimentacao_almoxarifado).Fields( Self.FModel.ToString ).Values; 
     ...
     SQL.Field(Self.FModel.nome_funcionario).Next;
  dbInsert;
  Result := (ListError.Count = 0); 
end; 

function TDalERPmotoristadocumentos.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(movimentacao_almoxarifado);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPmotoristadocumentos.Create ); 
      ...
      Self.FModelList[I].nome_funcionario      := SQL.getInteger(nome_funcionario);
      SQL.DataSet.Next;
    end;               
...
begin                                                                    
  ...
  SQL.Update(movimentacao_almoxarifado);
