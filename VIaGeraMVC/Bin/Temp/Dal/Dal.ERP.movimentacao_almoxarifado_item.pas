...
unit Dal.ERP.movimentacao_almoxarifado;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.movimentacao_almoxarifado, DalBaseCRUD,
  SQLQuery;

type
  TDalERPmovimentacaoalmoxarifado = class(TDalBaseCRUD)
  private 
...
function TDalERPmovimentacaoalmoxarifado.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPmovimentacaoalmoxarifado );              
...
function TDalERPmovimentacaoalmoxarifado.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(movimentacao_almoxarifado_item).Fields( Self.FModel.ToString ).Values; 
     SQL.Field(Self.FModel.id).Next;
     SQL.Field(Self.FModel.id_empresa).Next;
     SQL.Field(Self.FModel.id_mov_almoxarifado).Next;
...
function TDalERPmovimentacaoalmoxarifado.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(movimentacao_almoxarifado_item);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPmovimentacaoalmoxarifado.Create ); 
      Self.FModelList[I].id      := SQL.getInteger(id);
      Self.FModelList[I].id_empresa      := SQL.getInteger(id_empresa);
      Self.FModelList[I].id_mov_almoxarifado      := SQL.getInteger(id_mov_almoxarifado);
...
begin                                                                    
  ...
  SQL.Update(movimentacao_almoxarifado_item);
