...
unit Dal.ERP.nota_devol;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.nota_devol, DalBaseCRUD,
  SQLQuery;

type
  TDalERPnotadevol = class(TDalBaseCRUD)
  private 
...
function TDalERPnotadevol.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPnotadevol );              
...
function TDalERPnotadevol.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(op).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPnotadevol.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPnotadevol.Create ); 
