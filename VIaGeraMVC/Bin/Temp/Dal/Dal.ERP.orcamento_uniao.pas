...
unit Dal.ERP.orcamento;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.orcamento, DalBaseCRUD,
  SQLQuery;

type
  TDalERPorcamento = class(TDalBaseCRUD)
  private 
...
function TDalERPorcamento.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPorcamento );              
...
function TDalERPorcamento.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(orcamento_uniao).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPorcamento.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(orcamento_uniao);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPorcamento.Create ); 
