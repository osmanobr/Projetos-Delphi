...
uses
  ...
  ModelBase, ModelBaseList, Model.ERP.os, DalBaseCRUD,
  SQLQuery;

type
  TDalERPos = class(TDalBaseCRUD)
  private 
    FModel : TModelERPos;  
...
function TDalERPos.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPos );              
...
function TDalERPos.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(os_acessorio).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPos.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPos.Create ); 
