...
unit Dal.ERP.pdv_caixa;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.pdv_caixa, DalBaseCRUD,
  SQLQuery;

type
  TDalERPpdvcaixa = class(TDalBaseCRUD)
  private 
...
function TDalERPpdvcaixa.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPpdvcaixa );              
...
function TDalERPpdvcaixa.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(pdv_duplicata).Fields( Self.FModel.ToString ).Values; 
     SQL.Field(Self.FModel.id).Next;
     SQL.Field(Self.FModel.id_pdv).Next;
...
function TDalERPpdvcaixa.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPpdvcaixa.Create ); 
      Self.FModelList[I].id      := SQL.getInteger(id);
      Self.FModelList[I].id_pdv      := SQL.getInteger(id_pdv);
