...
unit Dal.ERP.pdv_item;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.pdv_item, DalBaseCRUD,
  SQLQuery;

type
  TDalERPpdvitem = class(TDalBaseCRUD)
  private 
...
function TDalERPpdvitem.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPpdvitem );              
...
function TDalERPpdvitem.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(pdv_lancamento).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPpdvitem.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPpdvitem.Create ); 
