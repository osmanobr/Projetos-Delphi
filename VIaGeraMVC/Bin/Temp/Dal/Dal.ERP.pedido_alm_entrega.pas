...
unit Dal.ERP.pedido_alm;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.pedido_alm, DalBaseCRUD,
  SQLQuery;

type
  TDalERPpedidoalm = class(TDalBaseCRUD)
  private 
...
function TDalERPpedidoalm.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPpedidoalm );              
...
function TDalERPpedidoalm.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(pedido_alm_entrega).Fields( Self.FModel.ToString ).Values; 
     SQL.Field(Self.FModel.id).Next;
     SQL.Field(Self.FModel.id_venda).Next;
     SQL.Field(Self.FModel.id_pedido_alm).Next;
     SQL.Field(Self.FModel.id_pedido_alm_item).Next;
...
function TDalERPpedidoalm.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(pedido_alm_entrega);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPpedidoalm.Create ); 
      Self.FModelList[I].id      := SQL.getInteger(id);
      Self.FModelList[I].id_venda      := SQL.getInteger(id_venda);
      Self.FModelList[I].id_pedido_alm      := SQL.getInteger(id_pedido_alm);
      Self.FModelList[I].id_pedido_alm_item      := SQL.getInteger(id_pedido_alm_item);
