...
unit Dal.ERP.pedido_compra;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.pedido_compra, DalBaseCRUD,
  SQLQuery;

type
  TDalERPpedidocompra = class(TDalBaseCRUD)
  private 
...
function TDalERPpedidocompra.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPpedidocompra );              
...
function TDalERPpedidocompra.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(pedido_compra_duplicata).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPpedidocompra.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(pedido_compra_duplicata);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPpedidocompra.Create ); 
...
begin                                                                    
  ...
  SQL.Update(pedido_compra_duplicata);
