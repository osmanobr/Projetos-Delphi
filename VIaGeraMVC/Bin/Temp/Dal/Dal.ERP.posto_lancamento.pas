...
unit Dal.ERP.posto_encerrante_vol_recebido;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.posto_encerrante_vol_recebido, DalBaseCRUD,
  SQLQuery;

type
  TDalERPpostoencerrantevolrecebido = class(TDalBaseCRUD)
  private 
...
function TDalERPpostoencerrantevolrecebido.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPpostoencerrantevolrecebido );              
...
function TDalERPpostoencerrantevolrecebido.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(posto_lancamento).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPpostoencerrantevolrecebido.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(posto_lancamento);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPpostoencerrantevolrecebido.Create ); 
