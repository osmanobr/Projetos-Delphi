...
unit Dal.ERP.promocao;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.promocao, DalBaseCRUD,
  SQLQuery;

type
  TDalERPpromocao = class(TDalBaseCRUD)
  private 
...
function TDalERPpromocao.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPpromocao );              
...
function TDalERPpromocao.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(promocao_historico).Fields( Self.FModel.ToString ).Values; 
...
function TDalERPpromocao.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(promocao_historico);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPpromocao.Create ); 
