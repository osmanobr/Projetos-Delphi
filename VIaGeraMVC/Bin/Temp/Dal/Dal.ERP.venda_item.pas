...
unit Dal.ERP.venda_entregaitem;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.venda_entregaitem, DalBaseCRUD,
  SQLQuery;

type
  TDalERPvendaentregaitem = class(TDalBaseCRUD)
  private 
...
function TDalERPvendaentregaitem.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPvendaentregaitem );              
...
function TDalERPvendaentregaitem.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(venda_item).Fields( Self.FModel.ToString ).Values; 
     ...
     SQL.Field(Self.FModel.percentual_desconto_item).Next;
     SQL.Field(Self.FModel.percentual_desconto).Next;
     SQL.Field(Self.FModel.promocao).Next;
     SQL.Field(Self.FModel.percentual_desc_definido).Next;
     SQL.Field(Self.FModel.id_produto_pai_kit).Next;
     SQL.Field(Self.FModel.obs).Next;
     SQL.Field(Self.FModel.vl_outro).Next;
     SQL.Field(Self.FModel.qtd_caixa).Next;
     SQL.Field(Self.FModel.codigo_ean).Next;
     SQL.Field(Self.FModel.id_venda_antiga).Next;
     SQL.Field(Self.FModel.unitario_caixa).Next;
     SQL.Field(Self.FModel.unidade_tributavel).Next;
     SQL.Field(Self.FModel.considerar_preco_caixa).Next;
  dbInsert;
  Result := (ListError.Count = 0); 
end; 

function TDalERPvendaentregaitem.Select(Model: TModelBase; 
...
begin                                                          
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPvendaentregaitem.Create ); 
      ...
      Self.FModelList[I].percentual_desconto_item      := SQL.getInteger(percentual_desconto_item);
      ...
      Self.FModelList[I].percentual_desc_definido      := SQL.getInteger(percentual_desc_definido);
      Self.FModelList[I].id_produto_pai_kit      := SQL.getInteger(id_produto_pai_kit);
      Self.FModelList[I].obs      := SQL.getInteger(obs);
      Self.FModelList[I].vl_outro      := SQL.getInteger(vl_outro);
      Self.FModelList[I].qtd_caixa      := SQL.getInteger(qtd_caixa);
      Self.FModelList[I].codigo_ean      := SQL.getInteger(codigo_ean);
      Self.FModelList[I].id_venda_antiga      := SQL.getInteger(id_venda_antiga);
      ...
      Self.FModelList[I].considerar_preco_caixa      := SQL.getInteger(considerar_preco_caixa);
      SQL.DataSet.Next;
    end;               
