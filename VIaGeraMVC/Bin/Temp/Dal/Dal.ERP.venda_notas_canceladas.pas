...
unit Dal.ERP.venda_item_serie;

interface
uses
  System.SysUtils, System.Classes, Data.DB, ListError, Parameters,
  System.Generics.Defaults, System.Generics.Collections, Utilitarios,
  ModelBase, ModelBaseList, Model.ERP.venda_item_serie, DalBaseCRUD,
  SQLQuery;

type
  TDalERPvendaitemserie = class(TDalBaseCRUD)
  private 
...
function TDalERPvendaitemserie.Delete(Model: TModelBase): Boolean; 
begin                                                                   
  ...
  Self.FModel := ( Model as TModelERPvendaitemserie );              
...
function TDalERPvendaitemserie.Insert(Model: TModelBase): Boolean; 
...
begin                                                                    
  ...
  SQL.Insert(venda_notas_canceladas).Fields( Self.FModel.ToString ).Values; 
     ...
     SQL.Field(Self.FModel.protocolo_venda).Next;
     SQL.Field(Self.FModel.protocolo_cancelamento).Next;
...
function TDalERPvendaitemserie.Select(Model: TModelBase; 
...
begin                                                          
  ...
  SQL.SelectFrom(venda_notas_canceladas);
  ...
  begin                                        
    ...
    begin                            
      I := Self.FModelList.Add( TModelERPvendaitemserie.Create ); 
      ...
      Self.FModelList[I].protocolo_venda      := SQL.getInteger(protocolo_venda);
      Self.FModelList[I].protocolo_cancelamento      := SQL.getInteger(protocolo_cancelamento);
...
begin                                                                    
  ...
  SQL.Update(venda_notas_canceladas);
