...
uses 
  ...
  Vcl.Grids, ViaERP.Funcoes, Controller.ERP.acerto, Controller.Types,              
  ViaERP.Utils, MsgTypes, ACBrBase, ACBrEnterTab;                                                  

type 
  TFrm_ViewERPacerto = class(TForm) 
    Panel1: TPanel; 
  ...
  private 
    FController : TControllerERPacerto; 
    Fid : Integer;
    Fid_empresa : Integer;
...
var
  Frm_ViewERPacerto : TFrm_ViewERPacerto; 
...
procedure TFrm_ViewERPacerto.ScreenToModel;  
begin   
  try   
...
procedure TFrm_ViewERPacerto.bbAlterarClick(Sender: TObject); 
begin 
...
procedure TFrm_ViewERPacerto.BBCancelarClick(Sender: TObject); 
begin                         
  LimparTela;                 
end;                          
...
procedure TFrm_ViewERPacerto.BBConfirmarClick(Sender: TObject);  
begin                                                                     
...
procedure TFrm_ViewERPacerto.bbExcluirClick(Sender: TObject);
begin 
 Self.FController.Delete;     
end; 

procedure TFrm_ViewERPacerto.bbIncluirClick(Sender: TObject);  
begin                       
  Self.FController.Status := vsInsert;   
end;    

procedure TFrm_ViewERPacerto.FormCreate(Sender: TObject);  
Var i:integer;                                                      
begin                                                               
    Self.FController := TControllerERPacerto.Create( SysFirst.SQLParam ); 
    Grid.RowCount := 1;         
    Grid.ColCount := 8;         
...
procedure TFrm_ViewERPacerto.FormDestroy(Sender: TObject);
begin
  FreeAndNil( FController 
end;

procedure TFrm_ViewERPacerto.FormShow(Sender: TObject);  
begin   
    LimparTela;   
    Self.FController.Get;   
    ModelToScreen;     
end; 
procedure TFrm_ViewERPacerto.GridClick(Sender: TObject);   
begin   
  try   
    FController.Model.Clear; 
...
procedure TFrm_ViewERPacerto.LimparTela;  
var   
  I: Integer;  
begin       
...
procedure TFrm_ViewERPacerto.Setid(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPacerto.Setid_empresa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPacerto.Setdata_acerto(const Value: TDateTime);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPacerto.Setmotivo(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPacerto.Setid_usuario(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPacerto.Setclick(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPacerto.Setgerado(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPacerto.Setestoque(const Value: WideString);  
begin    
  ativo:=value;  
end;  
end.
