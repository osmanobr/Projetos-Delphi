...
object  Frm_ViewERPatividade : TFrm_ViewERPatividade
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPatividade'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_total_autorizacao: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'total_autorizacao'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_faturado: TLabeledEdit       
          Left = 124              
          Top =  140              
          Width = 121                         
          Height = 21                         
