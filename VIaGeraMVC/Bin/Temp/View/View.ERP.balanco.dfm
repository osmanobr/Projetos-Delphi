...
object  Frm_ViewERPbackupcompress : TFrm_ViewERPbackupcompress
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPbackupcompress'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_consulta_rapida: TLabeledEdit       
          Left = 134              
          Top =  150              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'consulta_rapida'
          TabOrder = 0                        
        end                                   
        object Edit_lancar_inventario: TLabeledEdit       
          Left = 144              
          Top =  160              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'lancar_inventario'
          TabOrder = 0                        
        end                                   
        object Edit_lanca_acerto: TLabeledEdit       
          Left = 154              
          Top =  170              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'lanca_acerto'
          TabOrder = 0                        
        end                                   
