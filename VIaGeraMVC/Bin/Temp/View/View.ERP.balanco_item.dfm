...
object  Frm_ViewERPbalanco : TFrm_ViewERPbalanco
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPbalanco'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_id_balanco: TLabeledEdit       
          Left = 44              
          Top =  60              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_usuario_lancamento: TLabeledEdit       
          Left = 124              
          Top =  140              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'usuario_lancamento'
          TabOrder = 0                        
        end                                   
        object Edit_usuario_fechamento: TLabeledEdit       
          Left = 134              
          Top =  150              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'usuario_fechamento'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
