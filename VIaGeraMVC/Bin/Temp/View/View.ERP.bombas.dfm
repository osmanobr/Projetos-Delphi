...
object  Frm_ViewERPboletoautomatico : TFrm_ViewERPboletoautomatico
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPboletoautomatico'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_tipo_medicao: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'tipo_medicao'
          TabOrder = 0                        
        end                                   
        object Edit_lacre: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'lacre'
          TabOrder = 0                        
        end                                   
        object Edit_dt_aplic: TLabeledEdit       
          Left = 84              
          Top =  100              
          Width = 121                         
          Height = 21                         
