...
object  Frm_ViewERPbovinopecas : TFrm_ViewERPbovinopecas
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPbovinopecas'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_lista: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'lista'
          TabOrder = 0                        
        end                                   
        object Edit_lista_automatica: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'lista_automatica'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
