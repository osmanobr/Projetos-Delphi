...
object  Frm_ViewERPcalculofinanceiro : TFrm_ViewERPcalculofinanceiro
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPcalculofinanceiro'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_km_inicial: TLabeledEdit       
          Left = 114              
          Top =  130              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'km_inicial'
          TabOrder = 0                        
        end                                   
        object Edit_km_final: TLabeledEdit       
          Left = 124              
          Top =  140              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'km_final'
          TabOrder = 0                        
        end                                   
        object Edit_total_volumes: TLabeledEdit       
          Left = 134              
          Top =  150              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'total_volumes'
          TabOrder = 0                        
        end                                   
        object Edit_total_unidades: TLabeledEdit       
          Left = 144              
          Top =  160              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'total_unidades'
          TabOrder = 0                        
        end                                   
        object Edit_transporte: TLabeledEdit       
          Left = 154              
          Top =  170              
          Width = 121                         
          Height = 21                         
