...
object  Frm_ViewERPcarga : TFrm_ViewERPcarga
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPcarga'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_md5_total: TLabeledEdit       
          Left = 464              
          Top =  480              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'md5_total'
          TabOrder = 0                        
        end                                   
        object Edit_md5_alterado: TLabeledEdit       
          Left = 474              
          Top =  490              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'md5_alterado'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
