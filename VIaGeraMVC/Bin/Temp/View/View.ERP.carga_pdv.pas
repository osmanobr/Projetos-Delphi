...
uses 
  ...
  Vcl.Grids, ViaERP.Funcoes, Controller.ERP.carga, Controller.Types,              
  ViaERP.Utils, MsgTypes, ACBrBase, ACBrEnterTab;                                                  

type 
  TFrm_ViewERPcarga = class(TForm) 
    Panel1: TPanel; 
  ...
  private 
    FController : TControllerERPcarga; 
    Fid : Integer;
    Fid_empresa : Integer;
    Fid_grupo : Integer;
    Fnome : WideString;
  ...
  public
    ...
    property md5_total : WideString         read Fmd5_total    write Fmd5_total;
    property md5_alterado : WideString         read Fmd5_alterado    write Fmd5_alterado;

  end;

var
  Frm_ViewERPcarga : TFrm_ViewERPcarga; 
  ...
  for I := 0 to Self.FController.ModelList.Count-1 do   
    begin                                               
     //  Grid.RowCount := Grid.RowCount+1;              
         ...
         Grid.Cells[0,I+1] := inttostr(Self.FController.ModelList[I].md5_total); 
         Grid.Cells[0,I+1] := inttostr(Self.FController.ModelList[I].md5_alterado); 
    end; 
end; 

procedure TFrm_ViewERPcarga.ScreenToModel;  
begin   
  try   
      ...
      FController.Model.md5_total := Edit_md5_total.text;
      FController.Model.md5_alterado := Edit_md5_alterado.text;
...
procedure TFrm_ViewERPcarga.bbAlterarClick(Sender: TObject); 
begin 
...
procedure TFrm_ViewERPcarga.BBCancelarClick(Sender: TObject); 
begin                         
  LimparTela;                 
end;                          
...
procedure TFrm_ViewERPcarga.BBConfirmarClick(Sender: TObject);  
begin                                                                     
...
procedure TFrm_ViewERPcarga.bbExcluirClick(Sender: TObject);
begin 
 Self.FController.Delete;     
end; 

procedure TFrm_ViewERPcarga.bbIncluirClick(Sender: TObject);  
begin                       
  Self.FController.Status := vsInsert;   
end;    

procedure TFrm_ViewERPcarga.FormCreate(Sender: TObject);  
Var i:integer;                                                      
begin                                                               
    Self.FController := TControllerERPcarga.Create( SysFirst.SQLParam ); 
    Grid.RowCount := 1;         
    Grid.ColCount := 46;         
//  Grid.ColWidths[0] := 150;   
     ...
     Grid.Cells[inttostr(i),0] := md5_total;  
     Grid.Cells[inttostr(i),0] := md5_alterado;  
end;

procedure TFrm_ViewERPcarga.FormDestroy(Sender: TObject);
begin
  FreeAndNil( FController 
end;

procedure TFrm_ViewERPcarga.FormShow(Sender: TObject);  
begin   
    LimparTela;   
    Self.FController.Get;   
    ModelToScreen;     
end; 
procedure TFrm_ViewERPcarga.GridClick(Sender: TObject);   
begin   
  try   
    FController.Model.Clear; 
    ...
    FController.Model.md5_total := Grid.Cells[44,Grid.row];
    FController.Model.md5_alterado := Grid.Cells[45,Grid.row];
  Except

  end; 
end;

procedure TFrm_ViewERPcarga.LimparTela;  
var   
  I: Integer;  
begin       
...
procedure TFrm_ViewERPcarga.Setid(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setid_empresa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setid_grupo(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setnome(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setunidade(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setpreco_venda(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setpreco_atacado(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setfracionado(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setst(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Seticms(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setreducao(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setpromocao(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setpreco_promocao(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setippt(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setiat(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setatacado(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setquantidade_atacado(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setncm(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setcst(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setpiscofins(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setean(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setkit(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setbalanca_pdv(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Settabela_pdv(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setpreco_custo(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setcodigo_fabricante(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setespecial(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setcfop_interno(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setcfop_externo(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Settipo(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setean_caixa(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setean_caixa2(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setean_caixa3(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setembalagem_itens(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setembalagem_itens2(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setembalagem_itens3(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setpreco_custo_nf(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setpreco_custo_nf2(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setpreco_custo_nf3(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setvalor_unitario_item_nf(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setvalor_unitario_item_nf2(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setvalor_unitario_item_nf3(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setgenerico(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setcst_piscofins(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setmd5_total(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcarga.Setmd5_alterado(const Value: WideString);  
begin    
  ativo:=value;  
end;  
end.
