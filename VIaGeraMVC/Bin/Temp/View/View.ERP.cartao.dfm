...
object  Frm_ViewERPcartacorrecao : TFrm_ViewERPcartacorrecao
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPcartacorrecao'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_taxa_adm: TLabeledEdit       
          Left = 244              
          Top =  260              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'taxa_adm'
          TabOrder = 0                        
        end                                   
        object Edit_nome_venda: TLabeledEdit       
          Left = 254              
          Top =  270              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_vl_taxa_bancaria: TLabeledEdit       
          Left = 324              
          Top =  340              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'vl_taxa_bancaria'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_id_sub_forma: TLabeledEdit       
          Left = 364              
          Top =  380              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_sub_forma'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_nome_sub_forma: TLabeledEdit       
          Left = 384              
          Top =  400              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'nome_sub_forma'
          TabOrder = 0                        
        end                                   
