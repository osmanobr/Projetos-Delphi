...
object  Frm_ViewERPcestitens : TFrm_ViewERPcestitens
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPcestitens'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_preco_venda_original: TLabeledEdit       
          Left = 144              
          Top =  160              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'preco_venda_original'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
