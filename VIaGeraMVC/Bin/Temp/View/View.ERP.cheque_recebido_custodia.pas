...
uses 
  ...
  Vcl.Grids, ViaERP.Funcoes, Controller.ERP.cheque_recebido, Controller.Types,              
  ViaERP.Utils, MsgTypes, ACBrBase, ACBrEnterTab;                                                  

type 
  TFrm_ViewERPchequerecebido = class(TForm) 
    Panel1: TPanel; 
  ...
  private 
    FController : TControllerERPchequerecebido; 
    Fid : Integer;
    Fid_empresa : Integer;
    Fid_usuario : Integer;
    Fid_caixa : Integer;
  ...
  public
    ...
    property titulos : Double         read Ftitulos    write Ftitulos;
    property cheques : Double         read Fcheques    write Fcheques;
...
var
  Frm_ViewERPchequerecebido : TFrm_ViewERPchequerecebido; 
  ...
  for I := 0 to Self.FController.ModelList.Count-1 do   
    begin                                               
     //  Grid.RowCount := Grid.RowCount+1;              
         ...
         Grid.Cells[0,I+1] := inttostr(Self.FController.ModelList[I].titulos); 
         Grid.Cells[0,I+1] := inttostr(Self.FController.ModelList[I].cheques); 
         Grid.Cells[0,I+1] := inttostr(Self.FController.ModelList[I].dinheiro); 
         Grid.Cells[0,I+1] := inttostr(Self.FController.ModelList[I].obs); 
    end; 
end; 

procedure TFrm_ViewERPchequerecebido.ScreenToModel;  
begin   
  try   
      ...
      FController.Model.titulos := Edit_titulos.text;
      FController.Model.cheques := Edit_cheques.text;
      FController.Model.dinheiro := Edit_dinheiro.text;
...
procedure TFrm_ViewERPchequerecebido.bbAlterarClick(Sender: TObject); 
begin 
...
procedure TFrm_ViewERPchequerecebido.BBCancelarClick(Sender: TObject); 
begin                         
  LimparTela;                 
end;                          
...
procedure TFrm_ViewERPchequerecebido.BBConfirmarClick(Sender: TObject);  
begin                                                                     
...
procedure TFrm_ViewERPchequerecebido.bbExcluirClick(Sender: TObject);
begin 
 Self.FController.Delete;     
end; 

procedure TFrm_ViewERPchequerecebido.bbIncluirClick(Sender: TObject);  
begin                       
  Self.FController.Status := vsInsert;   
end;    

procedure TFrm_ViewERPchequerecebido.FormCreate(Sender: TObject);  
Var i:integer;                                                      
begin                                                               
    Self.FController := TControllerERPchequerecebido.Create( SysFirst.SQLParam ); 
    Grid.RowCount := 1;         
    Grid.ColCount := 19;         
//  Grid.ColWidths[0] := 150;   
     ...
     Grid.Cells[inttostr(i),0] := titulos;  
     Grid.Cells[inttostr(i),0] := cheques;  
     Grid.Cells[inttostr(i),0] := dinheiro;  
     Grid.Cells[inttostr(i),0] := obs;  
end;

procedure TFrm_ViewERPchequerecebido.FormDestroy(Sender: TObject);
begin
  FreeAndNil( FController 
end;

procedure TFrm_ViewERPchequerecebido.FormShow(Sender: TObject);  
begin   
    LimparTela;   
    Self.FController.Get;   
    ModelToScreen;     
end; 
procedure TFrm_ViewERPchequerecebido.GridClick(Sender: TObject);   
begin   
  try   
    FController.Model.Clear; 
    ...
    FController.Model.titulos := Grid.Cells[15,Grid.row];
    FController.Model.cheques := Grid.Cells[16,Grid.row];
    FController.Model.dinheiro := Grid.Cells[17,Grid.row];
    FController.Model.obs := Grid.Cells[18,Grid.row];
  Except

  end; 
end;

procedure TFrm_ViewERPchequerecebido.LimparTela;  
var   
  I: Integer;  
begin       
...
procedure TFrm_ViewERPchequerecebido.Setid(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setid_empresa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setid_usuario(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setid_caixa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setid_conta(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setid_banco(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setid_fornecedor(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setdata_custodia(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setvalor_bruto(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setpercentual_juros(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setvalor_juros(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setvalor_liquido(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setestado(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setcredor(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setclick(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Settitulos(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setcheques(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setdinheiro(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPchequerecebido.Setobs(const Value: WideString);  
begin    
  ativo:=value;  
end;  
end.
