...
object  Frm_ViewERPchequesemitidosexcluidos : TFrm_ViewERPchequesemitidosexcluidos
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPchequesemitidosexcluidos'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_idibge: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'idibge'
          TabOrder = 0                        
        end                                   
        object Edit_iduf: TLabeledEdit       
          Left = 84              
          Top =  100              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'iduf'
          TabOrder = 0                        
        end                                   
        object Edit_pais: TLabeledEdit       
          Left = 94              
          Top =  110              
          Width = 121                         
          Height = 21                         
