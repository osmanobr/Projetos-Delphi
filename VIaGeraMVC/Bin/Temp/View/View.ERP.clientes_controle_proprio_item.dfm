...
object  Frm_ViewERPclientesalterados : TFrm_ViewERPclientesalterados
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPclientesalterados'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_id_controle_proprio: TLabeledEdit       
          Left = 34              
          Top =  50              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_controle_proprio'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_data_vencimento: TLabeledEdit       
          Left = 94              
          Top =  110              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'data_vencimento'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_id_maquina: TLabeledEdit       
          Left = 114              
          Top =  130              
          Width = 121                         
          Height = 21                         
