...
object  Frm_ViewERPclientescoringa : TFrm_ViewERPclientescoringa
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPclientescoringa'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_vl_credito: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'vl_credito'
          TabOrder = 0                        
        end                                   
        object Edit_vl_usado: TLabeledEdit       
          Left = 84              
          Top =  100              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_id_origem: TLabeledEdit       
          Left = 114              
          Top =  130              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_data_estorno: TLabeledEdit       
          Left = 154              
          Top =  170              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'data_estorno'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
