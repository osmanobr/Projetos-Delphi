...
object  Frm_ViewERPclientesfotosdependentes : TFrm_ViewERPclientesfotosdependentes
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPclientesfotosdependentes'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_responsavel_telefone: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'responsavel_telefone'
          TabOrder = 0                        
        end                                   
        object Edit_responsavel_celular: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'responsavel_celular'
          TabOrder = 0                        
        end                                   
