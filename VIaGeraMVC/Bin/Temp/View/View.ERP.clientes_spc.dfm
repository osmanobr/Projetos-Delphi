...
object  Frm_ViewERPclientespropriedades : TFrm_ViewERPclientespropriedades
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPclientespropriedades'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_data_inclusao: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'data_inclusao'
          TabOrder = 0                        
        end                                   
        object Edit_data_exclusao: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'data_exclusao'
          TabOrder = 0                        
        end                                   
