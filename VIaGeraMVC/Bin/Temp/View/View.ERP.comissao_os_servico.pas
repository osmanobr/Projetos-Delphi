...
unit View.ERP.comissao_os_produto;
...
uses 
  ...
  Vcl.Grids, ViaERP.Funcoes, Controller.ERP.comissao_os_produto, Controller.Types,              
  ViaERP.Utils, MsgTypes, ACBrBase, ACBrEnterTab;                                                  

type 
  TFrm_ViewERPcomissaoosproduto = class(TForm) 
    Panel1: TPanel; 
  ...
  private 
    FController : TControllerERPcomissaoosproduto; 
    Fid : Integer;
    Fid_empresa : Integer;
    Fid_os : Integer;
...
var
  Frm_ViewERPcomissaoosproduto : TFrm_ViewERPcomissaoosproduto; 
...
procedure TFrm_ViewERPcomissaoosproduto.ScreenToModel;  
begin   
  try   
...
procedure TFrm_ViewERPcomissaoosproduto.bbAlterarClick(Sender: TObject); 
begin 
...
procedure TFrm_ViewERPcomissaoosproduto.BBCancelarClick(Sender: TObject); 
begin                         
  LimparTela;                 
end;                          
...
procedure TFrm_ViewERPcomissaoosproduto.BBConfirmarClick(Sender: TObject);  
begin                                                                     
...
procedure TFrm_ViewERPcomissaoosproduto.bbExcluirClick(Sender: TObject);
begin 
 Self.FController.Delete;     
end; 

procedure TFrm_ViewERPcomissaoosproduto.bbIncluirClick(Sender: TObject);  
begin                       
  Self.FController.Status := vsInsert;   
end;    

procedure TFrm_ViewERPcomissaoosproduto.FormCreate(Sender: TObject);  
Var i:integer;                                                      
begin                                                               
    Self.FController := TControllerERPcomissaoosproduto.Create( SysFirst.SQLParam ); 
    Grid.RowCount := 1;         
    Grid.ColCount := 23;         
...
procedure TFrm_ViewERPcomissaoosproduto.FormDestroy(Sender: TObject);
begin
  FreeAndNil( FController 
end;

procedure TFrm_ViewERPcomissaoosproduto.FormShow(Sender: TObject);  
begin   
    LimparTela;   
    Self.FController.Get;   
    ModelToScreen;     
end; 
procedure TFrm_ViewERPcomissaoosproduto.GridClick(Sender: TObject);   
begin   
  try   
    FController.Model.Clear; 
    ...
    FController.Model.id_funcionario := Grid.Cells[6,Grid.row];
    ...
    FController.Model.id_servico := Grid.Cells[10,Grid.row];
    FController.Model.nome_servico := Grid.Cells[11,Grid.row];
    FController.Model.vl_unitario := Grid.Cells[12,Grid.row];
    FController.Model.quantidade := Grid.Cells[13,Grid.row];
    FController.Model.desconto_servico := Grid.Cells[14,Grid.row];
    FController.Model.total_servico := Grid.Cells[15,Grid.row];
...
procedure TFrm_ViewERPcomissaoosproduto.LimparTela;  
var   
  I: Integer;  
begin       
...
procedure TFrm_ViewERPcomissaoosproduto.Setid(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setid_empresa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setid_os(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setdocumento(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setdata(const Value: TDateTime);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setid_vendedor(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setid_funcionario(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setid_cliente(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setid_forma(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setid_caixa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setid_servico(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setnome_servico(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setvl_unitario(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setquantidade(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setdesconto_servico(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Settotal_servico(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setvl_comissao(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setcancelada(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setavistaaprazo(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setoperacao(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setcomissao(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setpago(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosproduto.Setclick(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
end.
