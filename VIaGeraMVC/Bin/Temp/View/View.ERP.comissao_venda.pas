...
unit View.ERP.comissao_os_servico;
...
uses 
  ...
  Vcl.Grids, ViaERP.Funcoes, Controller.ERP.comissao_os_servico, Controller.Types,              
  ViaERP.Utils, MsgTypes, ACBrBase, ACBrEnterTab;                                                  

type 
  TFrm_ViewERPcomissaoosservico = class(TForm) 
    Panel1: TPanel; 
  ...
  private 
    FController : TControllerERPcomissaoosservico; 
    Fid : Integer;
    Fid_empresa : Integer;
    Fid_pedido : Integer;
    Fid_os : Integer;
...
var
  Frm_ViewERPcomissaoosservico : TFrm_ViewERPcomissaoosservico; 
  ...
  for I := 0 to Self.FController.ModelList.Count-1 do   
    begin                                               
     //  Grid.RowCount := Grid.RowCount+1;              
         ...
         Grid.Cells[0,I+1] := inttostr(Self.FController.ModelList[I].vl_promocao); 
    end; 
end; 

procedure TFrm_ViewERPcomissaoosservico.ScreenToModel;  
begin   
  try   
      ...
      FController.Model.vl_promocao := Edit_vl_promocao.text;
...
procedure TFrm_ViewERPcomissaoosservico.bbAlterarClick(Sender: TObject); 
begin 
...
procedure TFrm_ViewERPcomissaoosservico.BBCancelarClick(Sender: TObject); 
begin                         
  LimparTela;                 
end;                          
...
procedure TFrm_ViewERPcomissaoosservico.BBConfirmarClick(Sender: TObject);  
begin                                                                     
...
procedure TFrm_ViewERPcomissaoosservico.bbExcluirClick(Sender: TObject);
begin 
 Self.FController.Delete;     
end; 

procedure TFrm_ViewERPcomissaoosservico.bbIncluirClick(Sender: TObject);  
begin                       
  Self.FController.Status := vsInsert;   
end;    

procedure TFrm_ViewERPcomissaoosservico.FormCreate(Sender: TObject);  
Var i:integer;                                                      
begin                                                               
    Self.FController := TControllerERPcomissaoosservico.Create( SysFirst.SQLParam ); 
    Grid.RowCount := 1;         
    Grid.ColCount := 24;         
//  Grid.ColWidths[0] := 150;   
     ...
     Grid.Cells[inttostr(i),0] := vl_promocao;  
end;

procedure TFrm_ViewERPcomissaoosservico.FormDestroy(Sender: TObject);
begin
  FreeAndNil( FController 
end;

procedure TFrm_ViewERPcomissaoosservico.FormShow(Sender: TObject);  
begin   
    LimparTela;   
    Self.FController.Get;   
    ModelToScreen;     
end; 
procedure TFrm_ViewERPcomissaoosservico.GridClick(Sender: TObject);   
begin   
  try   
    FController.Model.Clear; 
    ...
    FController.Model.percentual_desconto := Grid.Cells[11,Grid.row];
    FController.Model.vl_servico := Grid.Cells[12,Grid.row];
    FController.Model.vl_produto := Grid.Cells[13,Grid.row];
    FController.Model.vl_total := Grid.Cells[14,Grid.row];
    FController.Model.vl_comissao := Grid.Cells[15,Grid.row];
    FController.Model.cancelada := Grid.Cells[16,Grid.row];
    FController.Model.avistaaprazo := Grid.Cells[17,Grid.row];
    FController.Model.operacao := Grid.Cells[18,Grid.row];
    FController.Model.comissao := Grid.Cells[19,Grid.row];
    FController.Model.pago := Grid.Cells[20,Grid.row];
    FController.Model.click := Grid.Cells[21,Grid.row];
    FController.Model.id_supervisor := Grid.Cells[22,Grid.row];
    FController.Model.vl_promocao := Grid.Cells[23,Grid.row];
  Except

  end; 
end;

procedure TFrm_ViewERPcomissaoosservico.LimparTela;  
var   
  I: Integer;  
begin       
...
procedure TFrm_ViewERPcomissaoosservico.Setid(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setid_empresa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setid_pedido(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setid_os(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setdocumento(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setdata(const Value: TDateTime);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setid_vendedor(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setid_cliente(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setnome_cliente(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setid_forma(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setid_caixa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setpercentual_desconto(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setvl_servico(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setvl_produto(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setvl_total(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setvl_comissao(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setcancelada(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setavistaaprazo(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setoperacao(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setcomissao(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setpago(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setclick(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setid_supervisor(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcomissaoosservico.Setvl_promocao(const Value: Double);  
begin    
  ativo:=value;  
end;  
end.
