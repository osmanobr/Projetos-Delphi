...
object  Frm_ViewERPcomissaovenda : TFrm_ViewERPcomissaovenda
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPcomissaovenda'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_vl_total_promocao: TLabeledEdit       
          Left = 284              
          Top =  300              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'vl_total_promocao'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
