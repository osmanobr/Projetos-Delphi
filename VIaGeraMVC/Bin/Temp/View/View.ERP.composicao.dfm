...
object  Frm_ViewERPcomissaovendaservico : TFrm_ViewERPcomissaovendaservico
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPcomissaovendaservico'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_maodeobra: TLabeledEdit       
          Left = 94              
          Top =  110              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'maodeobra'
          TabOrder = 0                        
        end                                   
        object Edit_maquinario: TLabeledEdit       
          Left = 104              
          Top =  120              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'maquinario'
          TabOrder = 0                        
        end                                   
        object Edit_outros: TLabeledEdit       
          Left = 114              
          Top =  130              
          Width = 121                         
          Height = 21                         
