...
object  Frm_ViewERPcomprakit : TFrm_ViewERPcomprakit
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPcomprakit'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_nro_serie_1: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'nro_serie_1'
          TabOrder = 0                        
        end                                   
        object Edit_nro_serie_2: TLabeledEdit       
          Left = 84              
          Top =  100              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'nro_serie_2'
          TabOrder = 0                        
        end                                   
        object Edit_nro_serie_3: TLabeledEdit       
          Left = 94              
          Top =  110              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_nro_serie_4: TLabeledEdit       
          Left = 114              
          Top =  130              
          Width = 121                         
          Height = 21                         
