...
object  Frm_ViewERPconsignadoitem : TFrm_ViewERPconsignadoitem
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPconsignadoitem'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_id_custodia_cheque: TLabeledEdit       
          Left = 284              
          Top =  300              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_custodia_cheque'
          TabOrder = 0                        
        end                                   
        object Edit_id_custodia_titulo: TLabeledEdit       
          Left = 294              
          Top =  310              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_custodia_titulo'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_data_competencia: TLabeledEdit       
          Left = 364              
          Top =  380              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'data_competencia'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
