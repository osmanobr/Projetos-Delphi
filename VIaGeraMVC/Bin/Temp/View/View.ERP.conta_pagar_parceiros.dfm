...
object  Frm_ViewERPcontapagarcomissaoparceiro : TFrm_ViewERPcontapagarcomissaoparceiro
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPcontapagarcomissaoparceiro'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_id_conta_pagar: TLabeledEdit       
          Left = 44              
          Top =  60              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_conta_pagar'
          TabOrder = 0                        
        end                                   
        object Edit_id_parceiro: TLabeledEdit       
          Left = 54              
          Top =  70              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_parceiro'
          TabOrder = 0                        
        end                                   
        object Edit_nome_parceiro: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'nome_parceiro'
          TabOrder = 0                        
        end                                   
