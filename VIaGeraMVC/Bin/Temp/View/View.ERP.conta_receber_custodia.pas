...
uses 
  ...
  Vcl.Grids, ViaERP.Funcoes, Controller.ERP.conta_receber, Controller.Types,              
  ViaERP.Utils, MsgTypes, ACBrBase, ACBrEnterTab;                                                  

type 
  TFrm_ViewERPcontareceber = class(TForm) 
    Panel1: TPanel; 
  ...
  private 
    FController : TControllerERPcontareceber; 
    Fid : Integer;
    Fid_empresa : Integer;
    Fid_usuario : Integer;
    Fid_caixa : Integer;
...
var
  Frm_ViewERPcontareceber : TFrm_ViewERPcontareceber; 
...
procedure TFrm_ViewERPcontareceber.ScreenToModel;  
begin   
  try   
...
procedure TFrm_ViewERPcontareceber.bbAlterarClick(Sender: TObject); 
begin 
...
procedure TFrm_ViewERPcontareceber.BBCancelarClick(Sender: TObject); 
begin                         
  LimparTela;                 
end;                          
...
procedure TFrm_ViewERPcontareceber.BBConfirmarClick(Sender: TObject);  
begin                                                                     
...
procedure TFrm_ViewERPcontareceber.bbExcluirClick(Sender: TObject);
begin 
 Self.FController.Delete;     
end; 

procedure TFrm_ViewERPcontareceber.bbIncluirClick(Sender: TObject);  
begin                       
  Self.FController.Status := vsInsert;   
end;    

procedure TFrm_ViewERPcontareceber.FormCreate(Sender: TObject);  
Var i:integer;                                                      
begin                                                               
    Self.FController := TControllerERPcontareceber.Create( SysFirst.SQLParam ); 
    Grid.RowCount := 1;         
    Grid.ColCount := 16;         
...
procedure TFrm_ViewERPcontareceber.FormDestroy(Sender: TObject);
begin
  FreeAndNil( FController 
end;

procedure TFrm_ViewERPcontareceber.FormShow(Sender: TObject);  
begin   
    LimparTela;   
    Self.FController.Get;   
    ModelToScreen;     
end; 
procedure TFrm_ViewERPcontareceber.GridClick(Sender: TObject);   
begin   
  try   
    FController.Model.Clear; 
...
procedure TFrm_ViewERPcontareceber.LimparTela;  
var   
  I: Integer;  
begin       
...
procedure TFrm_ViewERPcontareceber.Setid(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcontareceber.Setid_empresa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcontareceber.Setid_usuario(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcontareceber.Setid_caixa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcontareceber.Setid_conta(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcontareceber.Setid_banco(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcontareceber.Setid_fornecedor(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcontareceber.Setdata_custodia(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcontareceber.Setvalor_bruto(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcontareceber.Setpercentual_juros(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcontareceber.Setvalor_juros(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcontareceber.Setvalor_liquido(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcontareceber.Setestado(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcontareceber.Setcredor(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcontareceber.Setclick(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPcontareceber.Setobs(const Value: WideString);  
begin    
  ativo:=value;  
end;  
end.
