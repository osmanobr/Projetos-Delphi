...
object  Frm_ViewERPcontareceberfixalote : TFrm_ViewERPcontareceberfixalote
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPcontareceberfixalote'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_processado: TLabeledEdit       
          Left = 84              
          Top =  100              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_dbclick: TLabeledEdit       
          Left = 104              
          Top =  120              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'dbclick'
          TabOrder = 0                        
        end                                   
        object Edit_data_processo: TLabeledEdit       
          Left = 114              
          Top =  130              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'data_processo'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
