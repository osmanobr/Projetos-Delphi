...
object  Frm_ViewERPcontrato : TFrm_ViewERPcontrato
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPcontrato'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_contrato: TLabeledEdit       
          Left = 44              
          Top =  60              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_id_sistema: TLabeledEdit       
          Left = 84              
          Top =  100              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_data_cancelado: TLabeledEdit       
          Left = 104              
          Top =  120              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'data_cancelado'
          TabOrder = 0                        
        end                                   
        object Edit_motivo_cancelado: TLabeledEdit       
          Left = 114              
          Top =  130              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'motivo_cancelado'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
