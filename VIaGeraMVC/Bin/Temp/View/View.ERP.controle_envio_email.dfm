...
object  Frm_ViewERPcontroleentregaitem : TFrm_ViewERPcontroleentregaitem
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPcontroleentregaitem'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_endereco_cli: TLabeledEdit       
          Left = 144              
          Top =  160              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'endereco_cli'
          TabOrder = 0                        
        end                                   
        object Edit_cpf_cnpj_cli: TLabeledEdit       
          Left = 154              
          Top =  170              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'cpf_cnpj_cli'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_cupon_fiscal: TLabeledEdit       
          Left = 184              
          Top =  200              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'cupon_fiscal'
          TabOrder = 0                        
        end                                   
        object Edit_data_saida_venda: TLabeledEdit       
          Left = 194              
          Top =  210              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'data_saida_venda'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_descricao_email: TLabeledEdit       
          Left = 234              
          Top =  250              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'descricao_email'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
