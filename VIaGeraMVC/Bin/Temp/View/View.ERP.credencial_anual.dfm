...
object  Frm_ViewERPcredencial : TFrm_ViewERPcredencial
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPcredencial'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_id_classe: TLabeledEdit       
          Left = 34              
          Top =  50              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_classe'
          TabOrder = 0                        
        end                                   
        object Edit_id_credencial: TLabeledEdit       
          Left = 44              
          Top =  60              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_credencial'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_classe: TLabeledEdit       
          Left = 114              
          Top =  130              
          Width = 121                         
          Height = 21                         
