...
uses 
  ...
  Vcl.Grids, ViaERP.Funcoes, Controller.ERP.documentos, Controller.Types,              
  ViaERP.Utils, MsgTypes, ACBrBase, ACBrEnterTab;                                                  

type 
  TFrm_ViewERPdocumentos = class(TForm) 
    Panel1: TPanel; 
  ...
  private 
    FController : TControllerERPdocumentos; 
    Fid : Integer;
    Fid_empresa : Integer;
    Fnome : WideString;
    Flin : indefinido;
...
var
  Frm_ViewERPdocumentos : TFrm_ViewERPdocumentos; 
...
procedure TFrm_ViewERPdocumentos.ScreenToModel;  
begin   
  try   
...
procedure TFrm_ViewERPdocumentos.bbAlterarClick(Sender: TObject); 
begin 
...
procedure TFrm_ViewERPdocumentos.BBCancelarClick(Sender: TObject); 
begin                         
  LimparTela;                 
end;                          
...
procedure TFrm_ViewERPdocumentos.BBConfirmarClick(Sender: TObject);  
begin                                                                     
...
procedure TFrm_ViewERPdocumentos.bbExcluirClick(Sender: TObject);
begin 
 Self.FController.Delete;     
end; 

procedure TFrm_ViewERPdocumentos.bbIncluirClick(Sender: TObject);  
begin                       
  Self.FController.Status := vsInsert;   
end;    

procedure TFrm_ViewERPdocumentos.FormCreate(Sender: TObject);  
Var i:integer;                                                      
begin                                                               
    Self.FController := TControllerERPdocumentos.Create( SysFirst.SQLParam ); 
    Grid.RowCount := 1;         
    Grid.ColCount := 11;         
...
procedure TFrm_ViewERPdocumentos.FormDestroy(Sender: TObject);
begin
  FreeAndNil( FController 
end;

procedure TFrm_ViewERPdocumentos.FormShow(Sender: TObject);  
begin   
    LimparTela;   
    Self.FController.Get;   
    ModelToScreen;     
end; 
procedure TFrm_ViewERPdocumentos.GridClick(Sender: TObject);   
begin   
  try   
    FController.Model.Clear; 
...
procedure TFrm_ViewERPdocumentos.LimparTela;  
var   
  I: Integer;  
begin       
...
procedure TFrm_ViewERPdocumentos.Setid(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPdocumentos.Setid_empresa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPdocumentos.Setnome(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPdocumentos.Setlin(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPdocumentos.Setcol(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPdocumentos.Setfonte(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPdocumentos.Settamanho(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPdocumentos.Setimprime(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPdocumentos.Setcampo(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPdocumentos.Settabela(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPdocumentos.Settipo(const Value: WideString);  
begin    
  ativo:=value;  
end;  
end.
