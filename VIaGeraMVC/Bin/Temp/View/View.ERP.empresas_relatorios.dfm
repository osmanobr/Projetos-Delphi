...
object  Frm_ViewERPempresasparametros : TFrm_ViewERPempresasparametros
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPempresasparametros'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_texto_vazamento: TLabeledEdit       
          Left = 44              
          Top =  60              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'texto_vazamento'
          TabOrder = 0                        
        end                                   
        object Edit_texto_nao_vazamento: TLabeledEdit       
          Left = 54              
          Top =  70              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'texto_nao_vazamento'
          TabOrder = 0                        
        end                                   
