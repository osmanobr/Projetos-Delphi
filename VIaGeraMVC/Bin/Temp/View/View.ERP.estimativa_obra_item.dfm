...
object  Frm_ViewERPestimativaobrahistorico : TFrm_ViewERPestimativaobrahistorico
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPestimativaobrahistorico'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_id_estimativa_obra: TLabeledEdit       
          Left = 44              
          Top =  60              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_estimativa_obra'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_concluido: TLabeledEdit       
          Left = 124              
          Top =  140              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'concluido'
          TabOrder = 0                        
        end                                   
        object Edit_custo: TLabeledEdit       
          Left = 134              
          Top =  150              
          Width = 121                         
          Height = 21                         
