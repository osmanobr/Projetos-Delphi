...
object  Frm_ViewERPestoquebalanco : TFrm_ViewERPestoquebalanco
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPestoquebalanco'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_quantidade_disponivel: TLabeledEdit       
          Left = 104              
          Top =  120              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'quantidade_disponivel'
          TabOrder = 0                        
        end                                   
        object Edit_motivo_observacao: TLabeledEdit       
          Left = 114              
          Top =  130              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'motivo_observacao'
          TabOrder = 0                        
        end                                   
        object Edit_quantidade_anterior: TLabeledEdit       
          Left = 124              
          Top =  140              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'quantidade_anterior'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
