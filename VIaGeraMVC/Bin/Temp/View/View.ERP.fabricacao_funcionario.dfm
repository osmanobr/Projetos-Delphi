...
object  Frm_ViewERPfabricacao : TFrm_ViewERPfabricacao
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPfabricacao'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_nome_funcionario: TLabeledEdit       
          Left = 54              
          Top =  70              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'nome_funcionario'
          TabOrder = 0                        
        end                                   
