...
object  Frm_ViewERPfabricacaofuncionario : TFrm_ViewERPfabricacaofuncionario
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPfabricacaofuncionario'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_id_fabricacao: TLabeledEdit       
          Left = 44              
          Top =  60              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_fabricacao'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_nome_insumo: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_total_insumo: TLabeledEdit       
          Left = 84              
          Top =  100              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'total_insumo'
          TabOrder = 0                        
        end                                   
