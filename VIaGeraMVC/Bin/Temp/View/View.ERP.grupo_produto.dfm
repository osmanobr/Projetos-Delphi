...
object  Frm_ViewERPgrupo : TFrm_ViewERPgrupo
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPgrupo'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_coeficiente_fabricacao: TLabeledEdit       
          Left = 94              
          Top =  110              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'coeficiente_fabricacao'
          TabOrder = 0                        
        end                                   
        object Edit_frete_valor: TLabeledEdit       
          Left = 104              
          Top =  120              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'frete_valor'
          TabOrder = 0                        
        end                                   
        object Edit_comissao_vendedor: TLabeledEdit       
          Left = 114              
          Top =  130              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'comissao_vendedor'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
