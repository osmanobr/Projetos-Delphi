...
uses 
  ...
  Vcl.Grids, ViaERP.Funcoes, Controller.ERP.import_clientes, Controller.Types,              
  ViaERP.Utils, MsgTypes, ACBrBase, ACBrEnterTab;                                                  

type 
  TFrm_ViewERPimportclientes = class(TForm) 
    Panel1: TPanel; 
  ...
  private 
    FController : TControllerERPimportclientes; 
    Fid : Integer;
    Ftipo : WideString;
    Fid_empresa : Integer;
    Fnome : WideString;
...
var
  Frm_ViewERPimportclientes : TFrm_ViewERPimportclientes; 
...
procedure TFrm_ViewERPimportclientes.ScreenToModel;  
begin   
  try   
...
procedure TFrm_ViewERPimportclientes.bbAlterarClick(Sender: TObject); 
begin 
...
procedure TFrm_ViewERPimportclientes.BBCancelarClick(Sender: TObject); 
begin                         
  LimparTela;                 
end;                          
...
procedure TFrm_ViewERPimportclientes.BBConfirmarClick(Sender: TObject);  
begin                                                                     
...
procedure TFrm_ViewERPimportclientes.bbExcluirClick(Sender: TObject);
begin 
 Self.FController.Delete;     
end; 

procedure TFrm_ViewERPimportclientes.bbIncluirClick(Sender: TObject);  
begin                       
  Self.FController.Status := vsInsert;   
end;    

procedure TFrm_ViewERPimportclientes.FormCreate(Sender: TObject);  
Var i:integer;                                                      
begin                                                               
    Self.FController := TControllerERPimportclientes.Create( SysFirst.SQLParam ); 
    Grid.RowCount := 1;         
    Grid.ColCount := 36;         
...
procedure TFrm_ViewERPimportclientes.FormDestroy(Sender: TObject);
begin
  FreeAndNil( FController 
end;

procedure TFrm_ViewERPimportclientes.FormShow(Sender: TObject);  
begin   
    LimparTela;   
    Self.FController.Get;   
    ModelToScreen;     
end; 
procedure TFrm_ViewERPimportclientes.GridClick(Sender: TObject);   
begin   
  try   
    FController.Model.Clear; 
    ...
    FController.Model.alterado := Grid.Cells[35,Grid.row];
  Except

  end; 
end;

procedure TFrm_ViewERPimportclientes.LimparTela;  
var   
  I: Integer;  
begin       
...
procedure TFrm_ViewERPimportclientes.Setid(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Settipo(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setid_empresa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setnome(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setdata_ficha(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setrazao_social(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setid_cidade(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setendereco(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setbairro(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setuf(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setcep(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Settelefone(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setcnpj(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setcpf(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setinscricao_estadual(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setrg_ssp(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setrg(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setdata_nascimento(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setsexo(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setpai(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setmae(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setdependentes(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setconjugue(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setfuncao(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setspc(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setlimite(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setcompras(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setcidade(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setativo(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setatacado(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setestado_civil(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setobservacao(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setemail(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setbloqueio(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setcontribuinte_icms(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportclientes.Setalterado(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
end.
