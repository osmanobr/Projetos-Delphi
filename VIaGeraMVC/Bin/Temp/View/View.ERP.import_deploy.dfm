...
object  Frm_ViewERPimportcontroller : TFrm_ViewERPimportcontroller
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPimportcontroller'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_geracoes: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'geracoes'
          TabOrder = 0                        
        end                                   
        object Edit_tempo: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
