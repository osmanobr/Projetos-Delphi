...
uses 
  ...
  Vcl.Grids, ViaERP.Funcoes, Controller.ERP.import_deploy, Controller.Types,              
  ViaERP.Utils, MsgTypes, ACBrBase, ACBrEnterTab;                                                  

type 
  TFrm_ViewERPimportdeploy = class(TForm) 
    Panel1: TPanel; 
  ...
  private 
    FController : TControllerERPimportdeploy; 
    Fid : Integer;
    Fean : WideString;
    Fid_produto : Integer;
...
var
  Frm_ViewERPimportdeploy : TFrm_ViewERPimportdeploy; 
...
procedure TFrm_ViewERPimportdeploy.ScreenToModel;  
begin   
  try   
...
procedure TFrm_ViewERPimportdeploy.bbAlterarClick(Sender: TObject); 
begin 
...
procedure TFrm_ViewERPimportdeploy.BBCancelarClick(Sender: TObject); 
begin                         
  LimparTela;                 
end;                          
...
procedure TFrm_ViewERPimportdeploy.BBConfirmarClick(Sender: TObject);  
begin                                                                     
...
procedure TFrm_ViewERPimportdeploy.bbExcluirClick(Sender: TObject);
begin 
 Self.FController.Delete;     
end; 

procedure TFrm_ViewERPimportdeploy.bbIncluirClick(Sender: TObject);  
begin                       
  Self.FController.Status := vsInsert;   
end;    

procedure TFrm_ViewERPimportdeploy.FormCreate(Sender: TObject);  
Var i:integer;                                                      
begin                                                               
    Self.FController := TControllerERPimportdeploy.Create( SysFirst.SQLParam ); 
    Grid.RowCount := 1;         
    Grid.ColCount := 10;         
...
procedure TFrm_ViewERPimportdeploy.FormDestroy(Sender: TObject);
begin
  FreeAndNil( FController 
end;

procedure TFrm_ViewERPimportdeploy.FormShow(Sender: TObject);  
begin   
    LimparTela;   
    Self.FController.Get;   
    ModelToScreen;     
end; 
procedure TFrm_ViewERPimportdeploy.GridClick(Sender: TObject);   
begin   
  try   
    FController.Model.Clear; 
...
procedure TFrm_ViewERPimportdeploy.LimparTela;  
var   
  I: Integer;  
begin       
...
procedure TFrm_ViewERPimportdeploy.Setid(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportdeploy.Setean(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportdeploy.Setid_produto(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportdeploy.Setdescricao_produto(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportdeploy.Setunidade(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportdeploy.Setquantidade(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportdeploy.Setpreco_venda(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportdeploy.Setprimary_key(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportdeploy.Setean_principal(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportdeploy.Setativo(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
end.
