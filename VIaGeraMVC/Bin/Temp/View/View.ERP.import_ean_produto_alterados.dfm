...
object  Frm_ViewERPimporteanproduto : TFrm_ViewERPimporteanproduto
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPimporteanproduto'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_descricao_produto: TLabeledEdit       
          Left = 54              
          Top =  70              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'descricao_produto'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_primary_key: TLabeledEdit       
          Left = 94              
          Top =  110              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'primary_key'
          TabOrder = 0                        
        end                                   
        object Edit_ean_principal: TLabeledEdit       
          Left = 104              
          Top =  120              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'ean_principal'
          TabOrder = 0                        
        end                                   
