...
unit View.ERP.import_ean_produto;
...
uses 
  ...
  Vcl.Grids, ViaERP.Funcoes, Controller.ERP.import_ean_produto, Controller.Types,              
  ViaERP.Utils, MsgTypes, ACBrBase, ACBrEnterTab;                                                  

type 
  TFrm_ViewERPimporteanproduto = class(TForm) 
    Panel1: TPanel; 
  ...
  private 
    FController : TControllerERPimporteanproduto; 
    Fid : Integer;
    Fean : WideString;
    Fid_produto : Integer;
...
var
  Frm_ViewERPimporteanproduto : TFrm_ViewERPimporteanproduto; 
...
procedure TFrm_ViewERPimporteanproduto.ScreenToModel;  
begin   
  try   
...
procedure TFrm_ViewERPimporteanproduto.bbAlterarClick(Sender: TObject); 
begin 
...
procedure TFrm_ViewERPimporteanproduto.BBCancelarClick(Sender: TObject); 
begin                         
  LimparTela;                 
end;                          
...
procedure TFrm_ViewERPimporteanproduto.BBConfirmarClick(Sender: TObject);  
begin                                                                     
...
procedure TFrm_ViewERPimporteanproduto.bbExcluirClick(Sender: TObject);
begin 
 Self.FController.Delete;     
end; 

procedure TFrm_ViewERPimporteanproduto.bbIncluirClick(Sender: TObject);  
begin                       
  Self.FController.Status := vsInsert;   
end;    

procedure TFrm_ViewERPimporteanproduto.FormCreate(Sender: TObject);  
Var i:integer;                                                      
begin                                                               
    Self.FController := TControllerERPimporteanproduto.Create( SysFirst.SQLParam ); 
    Grid.RowCount := 1;         
    Grid.ColCount := 11;         
...
procedure TFrm_ViewERPimporteanproduto.FormDestroy(Sender: TObject);
begin
  FreeAndNil( FController 
end;

procedure TFrm_ViewERPimporteanproduto.FormShow(Sender: TObject);  
begin   
    LimparTela;   
    Self.FController.Get;   
    ModelToScreen;     
end; 
procedure TFrm_ViewERPimporteanproduto.GridClick(Sender: TObject);   
begin   
  try   
    FController.Model.Clear; 
    ...
    FController.Model.alterado := Grid.Cells[10,Grid.row];
  Except

  end; 
end;

procedure TFrm_ViewERPimporteanproduto.LimparTela;  
var   
  I: Integer;  
begin       
...
procedure TFrm_ViewERPimporteanproduto.Setid(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimporteanproduto.Setean(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimporteanproduto.Setid_produto(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimporteanproduto.Setdescricao_produto(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimporteanproduto.Setunidade(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimporteanproduto.Setquantidade(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimporteanproduto.Setpreco_venda(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimporteanproduto.Setprimary_key(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimporteanproduto.Setean_principal(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimporteanproduto.Setativo(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimporteanproduto.Setalterado(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
end.
