...
uses 
  ...
  Vcl.Grids, ViaERP.Funcoes, Controller.ERP.import_kit, Controller.Types,              
  ViaERP.Utils, MsgTypes, ACBrBase, ACBrEnterTab;                                                  

type 
  TFrm_ViewERPimportkit = class(TForm) 
    Panel1: TPanel; 
  ...
  private 
    FController : TControllerERPimportkit; 
    Fid : Integer;
    Fid_empresa : Integer;
    Fid_grupo : Integer;
    Fnome : WideString;
...
var
  Frm_ViewERPimportkit : TFrm_ViewERPimportkit; 
...
procedure TFrm_ViewERPimportkit.ScreenToModel;  
begin   
  try   
...
procedure TFrm_ViewERPimportkit.bbAlterarClick(Sender: TObject); 
begin 
...
procedure TFrm_ViewERPimportkit.BBCancelarClick(Sender: TObject); 
begin                         
  LimparTela;                 
end;                          
...
procedure TFrm_ViewERPimportkit.BBConfirmarClick(Sender: TObject);  
begin                                                                     
...
procedure TFrm_ViewERPimportkit.bbExcluirClick(Sender: TObject);
begin 
 Self.FController.Delete;     
end; 

procedure TFrm_ViewERPimportkit.bbIncluirClick(Sender: TObject);  
begin                       
  Self.FController.Status := vsInsert;   
end;    

procedure TFrm_ViewERPimportkit.FormCreate(Sender: TObject);  
Var i:integer;                                                      
begin                                                               
    Self.FController := TControllerERPimportkit.Create( SysFirst.SQLParam ); 
    Grid.RowCount := 1;         
    Grid.ColCount := 54;         
...
procedure TFrm_ViewERPimportkit.FormDestroy(Sender: TObject);
begin
  FreeAndNil( FController 
end;

procedure TFrm_ViewERPimportkit.FormShow(Sender: TObject);  
begin   
    LimparTela;   
    Self.FController.Get;   
    ModelToScreen;     
end; 
procedure TFrm_ViewERPimportkit.GridClick(Sender: TObject);   
begin   
  try   
    FController.Model.Clear; 
...
procedure TFrm_ViewERPimportkit.LimparTela;  
var   
  I: Integer;  
begin       
...
procedure TFrm_ViewERPimportkit.Setid(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setid_empresa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setid_grupo(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setnome(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setunidade(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setpreco_venda(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setpreco_atacado(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setfracionado(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setst(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Seticms(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setreducao(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setpromocao(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setpreco_promocao(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setippt(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setiat(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setatacado(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setquantidade_atacado(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setncm(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setcst(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setpiscofins(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setean(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setkit(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setbalanca_pdv(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Settabela_pdv(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setpreco_custo(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setcodigo_fabricante(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setespecial(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setcfop_interno(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setcfop_externo(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Settipo(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setean_caixa(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setean_caixa2(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setean_caixa3(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setembalagem_itens(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setembalagem_itens2(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setembalagem_itens3(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setpreco_custo_nf(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setpreco_custo_nf2(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setpreco_custo_nf3(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setvalor_unitario_item_nf(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setvalor_unitario_item_nf2(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setvalor_unitario_item_nf3(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setgenerico(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setcst_piscofins(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setsem_gtin(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setestoque_atual(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setvenda_metade(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setmetade_porcentagem(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setcnpj(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setcode(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setcst_cofins(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setcst_pis(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Setmetade_percentual(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPimportkit.Settrib(const Value: WideString);  
begin    
  ativo:=value;  
end;  
end.
