...
object  Frm_ViewERPimportprodutos : TFrm_ViewERPimportprodutos
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPimportprodutos'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_cst_piscofins: TLabeledEdit       
          Left = 454              
          Top =  470              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'cst_piscofins'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_metade_percentual: TLabeledEdit       
          Left = 544              
          Top =  560              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'metade_percentual'
          TabOrder = 0                        
        end                                   
