...
object  Frm_ViewERPindicacaoservico : TFrm_ViewERPindicacaoservico
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPindicacaoservico'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_dt_fab: TLabeledEdit       
          Left = 314              
          Top =  330              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'dt_fab'
          TabOrder = 0                        
        end                                   
        object Edit_dt_val: TLabeledEdit       
          Left = 324              
          Top =  340              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'dt_val'
          TabOrder = 0                        
        end                                   
        object Edit_dt_ent: TLabeledEdit       
          Left = 334              
          Top =  350              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'dt_ent'
          TabOrder = 0                        
        end                                   
        object Edit_mat_p: TLabeledEdit       
          Left = 344              
          Top =  360              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_temp_mat_p: TLabeledEdit       
          Left = 364              
          Top =  380              
          Width = 121                         
          Height = 21                         
