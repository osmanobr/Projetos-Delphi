...
uses 
  ...
  Vcl.Grids, ViaERP.Funcoes, Controller.ERP.inventario, Controller.Types,              
  ViaERP.Utils, MsgTypes, ACBrBase, ACBrEnterTab;                                                  

type 
  TFrm_ViewERPinventario = class(TForm) 
    Panel1: TPanel; 
  ...
  private 
    FController : TControllerERPinventario; 
    Fid : Integer;
    Fid_produto : Integer;
    Fnome : WideString;
    Funidade : WideString;
...
var
  Frm_ViewERPinventario : TFrm_ViewERPinventario; 
...
procedure TFrm_ViewERPinventario.ScreenToModel;  
begin   
  try   
...
procedure TFrm_ViewERPinventario.bbAlterarClick(Sender: TObject); 
begin 
...
procedure TFrm_ViewERPinventario.BBCancelarClick(Sender: TObject); 
begin                         
  LimparTela;                 
end;                          
...
procedure TFrm_ViewERPinventario.BBConfirmarClick(Sender: TObject);  
begin                                                                     
...
procedure TFrm_ViewERPinventario.bbExcluirClick(Sender: TObject);
begin 
 Self.FController.Delete;     
end; 

procedure TFrm_ViewERPinventario.bbIncluirClick(Sender: TObject);  
begin                       
  Self.FController.Status := vsInsert;   
end;    

procedure TFrm_ViewERPinventario.FormCreate(Sender: TObject);  
Var i:integer;                                                      
begin                                                               
    Self.FController := TControllerERPinventario.Create( SysFirst.SQLParam ); 
    Grid.RowCount := 1;         
    Grid.ColCount := 13;         
...
procedure TFrm_ViewERPinventario.FormDestroy(Sender: TObject);
begin
  FreeAndNil( FController 
end;

procedure TFrm_ViewERPinventario.FormShow(Sender: TObject);  
begin   
    LimparTela;   
    Self.FController.Get;   
    ModelToScreen;     
end; 
procedure TFrm_ViewERPinventario.GridClick(Sender: TObject);   
begin   
  try   
    FController.Model.Clear; 
    ...
    FController.Model.mes := Grid.Cells[10,Grid.row];
    FController.Model.quantidade_empresa_terceiro := Grid.Cells[11,Grid.row];
    FController.Model.quantidade_terceiro_empresa := Grid.Cells[12,Grid.row];
  Except

  end; 
end;

procedure TFrm_ViewERPinventario.LimparTela;  
var   
  I: Integer;  
begin       
...
procedure TFrm_ViewERPinventario.Setid(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPinventario.Setid_produto(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPinventario.Setnome(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPinventario.Setunidade(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPinventario.Setestoque_calculado(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPinventario.Setestoque_atual(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPinventario.Setpreco_custo(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPinventario.Setpreco_total(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPinventario.Setano(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPinventario.Setst(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPinventario.Setmes(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPinventario.Setquantidade_empresa_terceiro(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPinventario.Setquantidade_terceiro_empresa(const Value: Double);  
begin    
  ativo:=value;  
end;  
end.
