...
object  Frm_ViewERPinventariomes : TFrm_ViewERPinventariomes
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPinventariomes'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_estoque_calculado: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'estoque_calculado'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_preco_total: TLabeledEdit       
          Left = 94              
          Top =  110              
          Width = 121                         
          Height = 21                         
