...
object  Frm_ViewERPinventarios : TFrm_ViewERPinventarios
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPinventarios'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_preco_calculado: TLabeledEdit       
          Left = 84              
          Top =  100              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'preco_calculado'
          TabOrder = 0                        
        end                                   
        object Edit_espessura: TLabeledEdit       
          Left = 94              
          Top =  110              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_largura: TLabeledEdit       
          Left = 104              
          Top =  120              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_comprimento: TLabeledEdit       
          Left = 114              
          Top =  130              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_metro_cubico: TLabeledEdit       
          Left = 124              
          Top =  140              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'metro_cubico'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_vasilhame: TLabeledEdit       
          Left = 144              
          Top =  160              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'vasilhame'
          TabOrder = 0                        
        end                                   
        object Edit_kit_compra: TLabeledEdit       
          Left = 154              
          Top =  170              
          Width = 121                         
          Height = 21                         
