...
object  Frm_ViewERPleituracoletalote : TFrm_ViewERPleituracoletalote
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPleituracoletalote'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_id_modelo: TLabeledEdit       
          Left = 34              
          Top =  50              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_ultimo_fator: TLabeledEdit       
          Left = 164              
          Top =  180              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'ultimo_fator'
          TabOrder = 0                        
        end                                   
        object Edit_ultimo_valor: TLabeledEdit       
          Left = 174              
          Top =  190              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'ultimo_valor'
          TabOrder = 0                        
        end                                   
