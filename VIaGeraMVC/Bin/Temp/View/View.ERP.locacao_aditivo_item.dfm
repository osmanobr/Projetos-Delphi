...
object  Frm_ViewERPlocacaoaditivo : TFrm_ViewERPlocacaoaditivo
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPlocacaoaditivo'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_id_locacaoaditivo: TLabeledEdit       
          Left = 34              
          Top =  50              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_locacaoaditivo'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_valor_garantia: TLabeledEdit       
          Left = 104              
          Top =  120              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'valor_garantia'
          TabOrder = 0                        
        end                                   
