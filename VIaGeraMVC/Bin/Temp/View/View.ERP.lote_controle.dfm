...
object  Frm_ViewERPlotecontrolado : TFrm_ViewERPlotecontrolado
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPlotecontrolado'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_data_fabricacao: TLabeledEdit       
          Left = 54              
          Top =  70              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'data_fabricacao'
          TabOrder = 0                        
        end                                   
        object Edit_data_validade: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'data_validade'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_controle: TLabeledEdit       
          Left = 154              
          Top =  170              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_aviso_dias: TLabeledEdit       
          Left = 164              
          Top =  180              
          Width = 121                         
          Height = 21                         
