...
uses 
  ...
  Vcl.Grids, ViaERP.Funcoes, Controller.ERP.mesa, Controller.Types,              
  ViaERP.Utils, MsgTypes, ACBrBase, ACBrEnterTab;                                                  

type 
  TFrm_ViewERPmesa = class(TForm) 
    Panel1: TPanel; 
  ...
  private 
    FController : TControllerERPmesa; 
    Fid : Integer;
    Fid_caixa : Integer;
    Fid_usuario : Integer;
  ...
  public
    ...
    property hora_abre : WideString         read Fhora_abre    write Fhora_abre;
    property data_fecha : TDateTime         read Fdata_fecha    write Fdata_fecha;
    property hora_fecha : WideString         read Fhora_fecha    write Fhora_fecha;
...
var
  Frm_ViewERPmesa : TFrm_ViewERPmesa; 
...
procedure TFrm_ViewERPmesa.ScreenToModel;  
begin   
  try   
...
procedure TFrm_ViewERPmesa.bbAlterarClick(Sender: TObject); 
begin 
...
procedure TFrm_ViewERPmesa.BBCancelarClick(Sender: TObject); 
begin                         
  LimparTela;                 
end;                          
...
procedure TFrm_ViewERPmesa.BBConfirmarClick(Sender: TObject);  
begin                                                                     
...
procedure TFrm_ViewERPmesa.bbExcluirClick(Sender: TObject);
begin 
 Self.FController.Delete;     
end; 

procedure TFrm_ViewERPmesa.bbIncluirClick(Sender: TObject);  
begin                       
  Self.FController.Status := vsInsert;   
end;    

procedure TFrm_ViewERPmesa.FormCreate(Sender: TObject);  
Var i:integer;                                                      
begin                                                               
    Self.FController := TControllerERPmesa.Create( SysFirst.SQLParam ); 
    Grid.RowCount := 1;         
    Grid.ColCount := 53;         
...
procedure TFrm_ViewERPmesa.FormDestroy(Sender: TObject);
begin
  FreeAndNil( FController 
end;

procedure TFrm_ViewERPmesa.FormShow(Sender: TObject);  
begin   
    LimparTela;   
    Self.FController.Get;   
    ModelToScreen;     
end; 
procedure TFrm_ViewERPmesa.GridClick(Sender: TObject);   
begin   
  try   
    FController.Model.Clear; 
    ...
    FController.Model.debcre := Grid.Cells[51,Grid.row];
    FController.Model.historico := Grid.Cells[52,Grid.row];
  Except

  end; 
end;

procedure TFrm_ViewERPmesa.LimparTela;  
var   
  I: Integer;  
begin       
...
procedure TFrm_ViewERPmesa.Setid(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setid_caixa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setid_usuario(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setnome_caixa(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setstatus(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdata_abre(const Value: TDateTime);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Sethora_abre(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdata_fecha(const Value: TDateTime);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Sethora_fecha(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setvl_fundo(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setvl_sangria(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setid_forma1(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setvl_forma1(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdg_forma1(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setid_forma2(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setvl_forma2(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdg_forma2(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setid_forma3(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setvl_forma3(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdg_forma3(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setid_forma4(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setvl_forma4(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdg_forma4(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setid_forma5(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setvl_forma5(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdg_forma5(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setid_forma6(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setvl_forma6(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdg_forma6(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setid_forma7(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setvl_forma7(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdg_forma7(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setid_forma8(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setvl_forma8(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdg_forma8(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setid_forma9(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setvl_forma9(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdg_forma9(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setid_forma10(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setvl_forma10(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdg_forma10(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setvenda_bruta(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdg_outros(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdesconto(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setacrescimos(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setvenda_liquida(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdg_total(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdg_diferenca(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setcupons(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setitens(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setvl_abre(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Setdebcre(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPmesa.Sethistorico(const Value: WideString);  
begin    
  ativo:=value;  
end;  
end.
