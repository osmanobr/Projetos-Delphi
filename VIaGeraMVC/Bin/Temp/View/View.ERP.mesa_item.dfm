...
object  Frm_ViewERPmesahaver : TFrm_ViewERPmesahaver
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPmesahaver'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_id_mesa: TLabeledEdit       
          Left = 34              
          Top =  50              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_mesa'
          TabOrder = 0                        
        end                                   
        object Edit_mesa: TLabeledEdit       
          Left = 44              
          Top =  60              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_cozinha: TLabeledEdit       
          Left = 234              
          Top =  250              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'cozinha'
          TabOrder = 0                        
        end                                   
        object Edit_imprimiu: TLabeledEdit       
          Left = 244              
          Top =  260              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_copa: TLabeledEdit       
          ...
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'copa'
          TabOrder = 0                        
        end                                   
        object Edit_qtd_devolvida: TLabeledEdit       
          Left = 274              
          Top =  290              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'qtd_devolvida'
          TabOrder = 0                        
        end                                   
