...
object  Frm_ViewERPmodulos : TFrm_ViewERPmodulos
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPmodulos'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_prioridade: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'prioridade'
          TabOrder = 0                        
        end                                   
        object Edit_request: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'request'
          TabOrder = 0                        
        end                                   
        object Edit_process: TLabeledEdit       
          Left = 84              
          Top =  100              
          Width = 121                         
          Height = 21                         
