...
object  Frm_ViewERPmotorista : TFrm_ViewERPmotorista
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPmotorista'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_cartao_assinatura: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'cartao_assinatura'
          TabOrder = 0                        
        end                                   
        object Edit_doc: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
