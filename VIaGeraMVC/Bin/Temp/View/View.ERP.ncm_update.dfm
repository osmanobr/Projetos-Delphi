...
object  Frm_ViewERPncmtributacao : TFrm_ViewERPncmtributacao
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPncmtributacao'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_categoria: TLabeledEdit       
          Left = 44              
          Top =  60              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_codigocategoria: TLabeledEdit       
          Left = 54              
          Top =  70              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'codigocategoria'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
