...
object  Frm_ViewERPnfemanifestonsu : TFrm_ViewERPnfemanifestonsu
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPnfemanifestonsu'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_lin: TLabeledEdit       
          ...
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'lin'
          TabOrder = 0                        
        end                                   
        object Edit_col: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_imprime: TLabeledEdit       
          Left = 94              
          Top =  110              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'imprime'
          TabOrder = 0                        
        end                                   
        object Edit_campo: TLabeledEdit       
          Left = 104              
          Top =  120              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_tabela: TLabeledEdit       
          Left = 114              
          Top =  130              
          Width = 121                         
          Height = 21                         
