...
uses 
  ...
  Vcl.Grids, ViaERP.Funcoes, Controller.ERP.nota, Controller.Types,              
  ViaERP.Utils, MsgTypes, ACBrBase, ACBrEnterTab;                                                  

type 
  TFrm_ViewERPnota = class(TForm) 
    Panel1: TPanel; 
  ...
  private 
    FController : TControllerERPnota; 
    Fid : Integer;
    Fid_empresa : Integer;
    Fnome : indefinido;
    Flin : Integer;
...
var
  Frm_ViewERPnota : TFrm_ViewERPnota; 
...
procedure TFrm_ViewERPnota.ScreenToModel;  
begin   
  try   
...
procedure TFrm_ViewERPnota.bbAlterarClick(Sender: TObject); 
begin 
...
procedure TFrm_ViewERPnota.BBCancelarClick(Sender: TObject); 
begin                         
  LimparTela;                 
end;                          
...
procedure TFrm_ViewERPnota.BBConfirmarClick(Sender: TObject);  
begin                                                                     
...
procedure TFrm_ViewERPnota.bbExcluirClick(Sender: TObject);
begin 
 Self.FController.Delete;     
end; 

procedure TFrm_ViewERPnota.bbIncluirClick(Sender: TObject);  
begin                       
  Self.FController.Status := vsInsert;   
end;    

procedure TFrm_ViewERPnota.FormCreate(Sender: TObject);  
Var i:integer;                                                      
begin                                                               
    Self.FController := TControllerERPnota.Create( SysFirst.SQLParam ); 
    Grid.RowCount := 1;         
    Grid.ColCount := 11;         
...
procedure TFrm_ViewERPnota.FormDestroy(Sender: TObject);
begin
  FreeAndNil( FController 
end;

procedure TFrm_ViewERPnota.FormShow(Sender: TObject);  
begin   
    LimparTela;   
    Self.FController.Get;   
    ModelToScreen;     
end; 
procedure TFrm_ViewERPnota.GridClick(Sender: TObject);   
begin   
  try   
    FController.Model.Clear; 
...
procedure TFrm_ViewERPnota.LimparTela;  
var   
  I: Integer;  
begin       
...
procedure TFrm_ViewERPnota.Setid(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPnota.Setid_empresa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPnota.Setnome(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPnota.Setlin(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPnota.Setcol(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPnota.Setfonte(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPnota.Settamanho(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPnota.Setimprime(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPnota.Setcampo(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPnota.Settabela(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPnota.Settipo(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
end.
