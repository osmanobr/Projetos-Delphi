...
object  Frm_ViewERPop : TFrm_ViewERPop
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPop'
  ClientHeight = 507                          
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_id_op: TLabeledEdit       
          Left = 34              
          Top =  50              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_quantidade_perdas: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'quantidade_perdas'
          TabOrder = 0                        
        end                                   
        object Edit_quantidade_boas: TLabeledEdit       
          Left = 84              
          Top =  100              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'quantidade_boas'
          TabOrder = 0                        
        end                                   
