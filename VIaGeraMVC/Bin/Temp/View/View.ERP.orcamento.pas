...
uses 
  ...
  Vcl.Grids, ViaERP.Funcoes, Controller.ERP.op_item, Controller.Types,              
  ViaERP.Utils, MsgTypes, ACBrBase, ACBrEnterTab;                                                  

type 
  TFrm_ViewERPopitem = class(TForm) 
    Panel1: TPanel; 
  ...
  private 
    FController : TControllerERPopitem; 
    Fid : Integer;
    Fid_empresa : Integer;
    Fnome : indefinido;
    Flin : Integer;
...
var
  Frm_ViewERPopitem : TFrm_ViewERPopitem; 
...
procedure TFrm_ViewERPopitem.ScreenToModel;  
begin   
  try   
...
procedure TFrm_ViewERPopitem.bbAlterarClick(Sender: TObject); 
begin 
...
procedure TFrm_ViewERPopitem.BBCancelarClick(Sender: TObject); 
begin                         
  LimparTela;                 
end;                          
...
procedure TFrm_ViewERPopitem.BBConfirmarClick(Sender: TObject);  
begin                                                                     
...
procedure TFrm_ViewERPopitem.bbExcluirClick(Sender: TObject);
begin 
 Self.FController.Delete;     
end; 

procedure TFrm_ViewERPopitem.bbIncluirClick(Sender: TObject);  
begin                       
  Self.FController.Status := vsInsert;   
end;    

procedure TFrm_ViewERPopitem.FormCreate(Sender: TObject);  
Var i:integer;                                                      
begin                                                               
    Self.FController := TControllerERPopitem.Create( SysFirst.SQLParam ); 
    Grid.RowCount := 1;         
    Grid.ColCount := 11;         
...
procedure TFrm_ViewERPopitem.FormDestroy(Sender: TObject);
begin
  FreeAndNil( FController 
end;

procedure TFrm_ViewERPopitem.FormShow(Sender: TObject);  
begin   
    LimparTela;   
    Self.FController.Get;   
    ModelToScreen;     
end; 
procedure TFrm_ViewERPopitem.GridClick(Sender: TObject);   
begin   
  try   
    FController.Model.Clear; 
...
procedure TFrm_ViewERPopitem.LimparTela;  
var   
  I: Integer;  
begin       
...
procedure TFrm_ViewERPopitem.Setid(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPopitem.Setid_empresa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPopitem.Setnome(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPopitem.Setlin(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPopitem.Setcol(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPopitem.Setfonte(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPopitem.Settamanho(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPopitem.Setimprime(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPopitem.Setcampo(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPopitem.Settabela(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPopitem.Settipo(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
end.
