...
object  Frm_ViewERPpagarexcluidos : TFrm_ViewERPpagarexcluidos
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPpagarexcluidos'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    Align = alClient                 
    TabOrder = 1                     
        object Edit_iditem: TLabeledEdit       
          Left = 24              
          Top =  40              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'iditem'
          TabOrder = 0                        
        end                                   
        object Edit_numeropedido: TLabeledEdit       
          Left = 34              
          Top =  50              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'numeropedido'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_valorunitario: TLabeledEdit       
          Left = 104              
          Top =  120              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'valorunitario'
          TabOrder = 0                        
        end                                   
