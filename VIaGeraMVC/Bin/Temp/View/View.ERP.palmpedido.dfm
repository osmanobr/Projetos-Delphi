...
object  Frm_ViewERPpalmitem : TFrm_ViewERPpalmitem
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPpalmitem'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    Align = alClient                 
    TabOrder = 1                     
        object Edit_idpedido: TLabeledEdit       
          Left = 24              
          Top =  40              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_cliente: TLabeledEdit       
          Left = 44              
          Top =  60              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_vendedor: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_dtentrega: TLabeledEdit       
          Left = 84              
          Top =  100              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'dtentrega'
          TabOrder = 0                        
        end                                   
        object Edit_condpagto: TLabeledEdit       
          Left = 94              
          Top =  110              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'condpagto'
          TabOrder = 0                        
        end                                   
        object Edit_vlsubtotal: TLabeledEdit       
          Left = 104              
          Top =  120              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'vlsubtotal'
          TabOrder = 0                        
        end                                   
        object Edit_vldesconto: TLabeledEdit       
          Left = 114              
          Top =  130              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'vldesconto'
          TabOrder = 0                        
        end                                   
        object Edit_vltotal: TLabeledEdit       
          Left = 124              
          Top =  140              
          Width = 121                         
          Height = 21                         
