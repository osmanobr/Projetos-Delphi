...
object  Frm_ViewERPpdv : TFrm_ViewERPpdv
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPpdv'
  ClientHeight = 507                          
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_canceladas: TLabeledEdit       
          Left = 534              
          Top =  550              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'canceladas'
          TabOrder = 0                        
        end                                   
        object Edit_vl_cancelada: TLabeledEdit       
          Left = 544              
          Top =  560              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'vl_cancelada'
          TabOrder = 0                        
        end                                   
