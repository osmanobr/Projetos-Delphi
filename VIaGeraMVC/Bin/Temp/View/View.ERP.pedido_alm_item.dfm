...
object  Frm_ViewERPpedidoalmentrega : TFrm_ViewERPpedidoalmentrega
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPpedidoalmentrega'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_qtd_entrega: TLabeledEdit       
          Left = 164              
          Top =  180              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'qtd_entrega'
          TabOrder = 0                        
        end                                   
        object Edit_entregue: TLabeledEdit       
          Left = 174              
          Top =  190              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_id_estimativa_obra_item: TLabeledEdit       
          Left = 194              
          Top =  210              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_estimativa_obra_item'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
