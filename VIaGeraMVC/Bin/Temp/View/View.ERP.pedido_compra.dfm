...
object  Frm_ViewERPpedidocarregamento : TFrm_ViewERPpedidocarregamento
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPpedidocarregamento'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_data_pedido: TLabeledEdit       
          Left = 44              
          Top =  60              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_previsao: TLabeledEdit       
          Left = 94              
          Top =  110              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_valor_icms: TLabeledEdit       
          Left = 114              
          Top =  130              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'valor_icms'
          TabOrder = 0                        
        end                                   
        object Edit_valor_st: TLabeledEdit       
          Left = 124              
          Top =  140              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_total_nota: TLabeledEdit       
          Left = 154              
          Top =  170              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'total_nota'
          TabOrder = 0                        
        end                                   
        object Edit_base_st: TLabeledEdit       
          Left = 164              
          Top =  180              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'base_st'
          TabOrder = 0                        
        end                                   
        object Edit_nome_representante: TLabeledEdit       
          Left = 174              
          Top =  190              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'nome_representante'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
