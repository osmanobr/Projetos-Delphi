...
object  Frm_ViewERPplanocelular : TFrm_ViewERPplanocelular
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPplanocelular'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_inversao_plano_conta: TLabeledEdit       
          Left = 84              
          Top =  100              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'inversao_plano_conta'
          TabOrder = 0                        
        end                                   
