...
object  Frm_ViewERPpostocaixa : TFrm_ViewERPpostocaixa
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPpostocaixa'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_estoque_abertura: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'estoque_abertura'
          TabOrder = 0                        
        end                                   
        object Edit_fechamento_fisico: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'fechamento_fisico'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_volume_recebido: TLabeledEdit       
          Left = 94              
          Top =  110              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'volume_recebido'
          TabOrder = 0                        
        end                                   
        object Edit_obs_revendedor: TLabeledEdit       
          Left = 104              
          Top =  120              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'obs_revendedor'
          TabOrder = 0                        
        end                                   
