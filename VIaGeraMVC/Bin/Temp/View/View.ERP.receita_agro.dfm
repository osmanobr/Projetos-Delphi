...
object  Frm_ViewERPreajusteprecoitens : TFrm_ViewERPreajusteprecoitens
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPreajusteprecoitens'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_art: TLabeledEdit       
          ...
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'art'
          TabOrder = 0                        
        end                                   
        object Edit_visto: TLabeledEdit       
          Left = 54              
          Top =  70              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_local_aplicacao: TLabeledEdit       
          Left = 124              
          Top =  140              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'local_aplicacao'
          TabOrder = 0                        
        end                                   
        object Edit_unidade_recebimento: TLabeledEdit       
          Left = 134              
          Top =  150              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'unidade_recebimento'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
