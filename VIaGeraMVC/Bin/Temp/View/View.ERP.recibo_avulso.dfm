...
object  Frm_ViewERPreceitaagroprodutos : TFrm_ViewERPreceitaagroprodutos
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPreceitaagroprodutos'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_id_cli: TLabeledEdit       
          Left = 34              
          Top =  50              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_cli'
          TabOrder = 0                        
        end                                   
        object Edit_id_for: TLabeledEdit       
          Left = 44              
          Top =  60              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_nro_doc: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'nro_doc'
          TabOrder = 0                        
        end                                   
        object Edit_correspondente: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'correspondente'
          TabOrder = 0                        
        end                                   
