...
object  Frm_ViewERPregistrotef : TFrm_ViewERPregistrotef
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPregistrotef'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_nome_arquivo: TLabeledEdit       
          Left = 84              
          Top =  100              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'nome_arquivo'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_inutilizada: TLabeledEdit       
          Left = 104              
          Top =  120              
          Width = 121                         
          Height = 21                         
