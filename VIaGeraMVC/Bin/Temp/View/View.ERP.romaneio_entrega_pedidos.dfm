...
object  Frm_ViewERPromaneioentrega : TFrm_ViewERPromaneioentrega
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPromaneioentrega'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_id_romaneio: TLabeledEdit       
          Left = 34              
          Top =  50              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_id_venda_novo: TLabeledEdit       
          Left = 54              
          Top =  70              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_venda_novo'
          TabOrder = 0                        
        end                                   
