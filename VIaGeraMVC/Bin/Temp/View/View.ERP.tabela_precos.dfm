...
object  Frm_ViewERPsupervisor : TFrm_ViewERPsupervisor
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPsupervisor'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_reajuste_tipo: TLabeledEdit       
          Left = 84              
          Top =  100              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'reajuste_tipo'
          TabOrder = 0                        
        end                                   
        object Edit_reajuste_percentual: TLabeledEdit       
          Left = 94              
          Top =  110              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'reajuste_percentual'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_formas_novo: TLabeledEdit       
          Left = 144              
          Top =  160              
          Width = 121                         
          Height = 21                         
