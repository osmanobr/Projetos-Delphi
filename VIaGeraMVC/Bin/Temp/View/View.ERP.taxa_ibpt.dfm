...
object  Frm_ViewERPtanque : TFrm_ViewERPtanque
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPtanque'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_aliqnacional: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'aliqnacional'
          TabOrder = 0                        
        end                                   
        object Edit_aliqinternacional: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'aliqinternacional'
          TabOrder = 0                        
        end                                   
