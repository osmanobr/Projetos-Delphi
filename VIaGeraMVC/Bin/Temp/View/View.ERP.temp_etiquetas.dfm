...
object  Frm_ViewERPtelefoneparceiro : TFrm_ViewERPtelefoneparceiro
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPtelefoneparceiro'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_preco_venda2: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'preco_venda2'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_datanf: TLabeledEdit       
          Left = 144              
          Top =  160              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'datanf'
          TabOrder = 0                        
        end                                   
        object Edit_valor_parcelas: TLabeledEdit       
          Left = 154              
          Top =  170              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'valor_parcelas'
          TabOrder = 0                        
        end                                   
        object Edit_quantidade_parcela: TLabeledEdit       
          Left = 164              
          Top =  180              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'quantidade_parcela'
          TabOrder = 0                        
        end                                   
        object Edit_valor_embalagem: TLabeledEdit       
          Left = 174              
          Top =  190              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'valor_embalagem'
          TabOrder = 0                        
        end                                   
        object Edit_quantidade_itens_embalagem: TLabeledEdit       
          Left = 184              
          Top =  200              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'quantidade_itens_embalagem'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_data_compra: TLabeledEdit       
          Left = 204              
          Top =  220              
          Width = 121                         
          Height = 21                         
