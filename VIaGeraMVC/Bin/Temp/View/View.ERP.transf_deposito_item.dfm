...
object  Frm_ViewERPtransfdeposito : TFrm_ViewERPtransfdeposito
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPtransfdeposito'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_id_transf_deposito: TLabeledEdit       
          Left = 34              
          Top =  50              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_transf_deposito'
          TabOrder = 0                        
        end                                   
        object Edit_id_produto_origem: TLabeledEdit       
          Left = 44              
          Top =  60              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_produto_origem'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_id_produto_destino: TLabeledEdit       
          Left = 134              
          Top =  150              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_produto_destino'
          TabOrder = 0                        
        end                                   
