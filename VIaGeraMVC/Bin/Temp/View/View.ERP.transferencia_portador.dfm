...
object  Frm_ViewERPtransfdepositoitem : TFrm_ViewERPtransfdepositoitem
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPtransfdepositoitem'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_id_origem_conta: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_origem_conta'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_id_destino: TLabeledEdit       
          Left = 94              
          Top =  110              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_destino'
          TabOrder = 0                        
        end                                   
        object Edit_id_destino_conta: TLabeledEdit       
          Left = 104              
          Top =  120              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_destino_conta'
          TabOrder = 0                        
        end                                   
