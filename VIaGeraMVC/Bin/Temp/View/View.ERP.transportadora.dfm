...
object  Frm_ViewERPtransferenciaportador : TFrm_ViewERPtransferenciaportador
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPtransferenciaportador'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_contato_nome: TLabeledEdit       
          Left = 224              
          Top =  240              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'contato_nome'
          TabOrder = 0                        
        end                                   
        object Edit_contato_fone: TLabeledEdit       
          Left = 234              
          Top =  250              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'contato_fone'
          TabOrder = 0                        
        end                                   
        object Edit_contato_celular: TLabeledEdit       
          Left = 244              
          Top =  260              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'contato_celular'
          TabOrder = 0                        
        end                                   
        object Edit_contato_e_mail: TLabeledEdit       
          Left = 254              
          Top =  270              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'contato_e_mail'
          TabOrder = 0                        
        end                                   
