...
object  Frm_ViewERPvenda : TFrm_ViewERPvenda
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPvenda'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_taxa_juros: TLabeledEdit       
          Left = 94              
          Top =  110              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_juros_pago: TLabeledEdit       
          Left = 124              
          Top =  140              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_avista: TLabeledEdit       
          Left = 144              
          Top =  160              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_vl_financeiro: TLabeledEdit       
          Left = 204              
          Top =  220              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'vl_financeiro'
          TabOrder = 0                        
        end                                   
        object Edit_acredito: TLabeledEdit       
          Left = 214              
          Top =  230              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_id_venda_uniao: TLabeledEdit       
          Left = 234              
          Top =  250              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'id_venda_uniao'
          TabOrder = 0                        
        end                                   
  end                                         
      end                                     
