...
uses 
  ...
  Vcl.Grids, ViaERP.Funcoes, Controller.ERP.venda, Controller.Types,              
  ViaERP.Utils, MsgTypes, ACBrBase, ACBrEnterTab;                                                  

type 
  TFrm_ViewERPvenda = class(TForm) 
    Panel1: TPanel; 
  ...
  private 
    FController : TControllerERPvenda; 
    Fid : Integer;
    Fid_venda : Integer;
    Fid_empresa : Integer;
    Fdata : TDateTime;
  ...
  public
    ...
    property vl_financeiro : Double         read Fvl_financeiro    write Fvl_financeiro;
    property acredito : Boolean         read Facredito    write Facredito;
...
var
  Frm_ViewERPvenda : TFrm_ViewERPvenda; 
  ...
  for I := 0 to Self.FController.ModelList.Count-1 do   
    begin                                               
     //  Grid.RowCount := Grid.RowCount+1;              
         ...
         Grid.Cells[0,I+1] := inttostr(Self.FController.ModelList[I].vl_financeiro); 
         Grid.Cells[0,I+1] := inttostr(Self.FController.ModelList[I].acredito); 
...
procedure TFrm_ViewERPvenda.ScreenToModel;  
begin   
  try   
      ...
      FController.Model.vl_financeiro := Edit_vl_financeiro.text;
      FController.Model.acredito := Edit_acredito.text;
...
procedure TFrm_ViewERPvenda.bbAlterarClick(Sender: TObject); 
begin 
...
procedure TFrm_ViewERPvenda.BBCancelarClick(Sender: TObject); 
begin                         
  LimparTela;                 
end;                          
...
procedure TFrm_ViewERPvenda.BBConfirmarClick(Sender: TObject);  
begin                                                                     
...
procedure TFrm_ViewERPvenda.bbExcluirClick(Sender: TObject);
begin 
 Self.FController.Delete;     
end; 

procedure TFrm_ViewERPvenda.bbIncluirClick(Sender: TObject);  
begin                       
  Self.FController.Status := vsInsert;   
end;    

procedure TFrm_ViewERPvenda.FormCreate(Sender: TObject);  
Var i:integer;                                                      
begin                                                               
    Self.FController := TControllerERPvenda.Create( SysFirst.SQLParam ); 
    Grid.RowCount := 1;         
    Grid.ColCount := 22;         
//  Grid.ColWidths[0] := 150;   
     ...
     Grid.Cells[inttostr(i),0] := vl_financeiro;  
     Grid.Cells[inttostr(i),0] := acredito;  
     Grid.Cells[inttostr(i),0] := uniao;  
     Grid.Cells[inttostr(i),0] := id_venda_uniao;  
end;

procedure TFrm_ViewERPvenda.FormDestroy(Sender: TObject);
begin
  FreeAndNil( FController 
end;

procedure TFrm_ViewERPvenda.FormShow(Sender: TObject);  
begin   
    LimparTela;   
    Self.FController.Get;   
    ModelToScreen;     
end; 
procedure TFrm_ViewERPvenda.GridClick(Sender: TObject);   
begin   
  try   
    FController.Model.Clear; 
    ...
    FController.Model.id_movimento := Grid.Cells[15,Grid.row];
    FController.Model.id_cupons := Grid.Cells[16,Grid.row];
    FController.Model.id_pagamentos := Grid.Cells[17,Grid.row];
    FController.Model.vl_financeiro := Grid.Cells[18,Grid.row];
    FController.Model.acredito := Grid.Cells[19,Grid.row];
    FController.Model.uniao := Grid.Cells[20,Grid.row];
    FController.Model.id_venda_uniao := Grid.Cells[21,Grid.row];
  Except

  end; 
end;

procedure TFrm_ViewERPvenda.LimparTela;  
var   
  I: Integer;  
begin       
...
procedure TFrm_ViewERPvenda.Setid(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setid_venda(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setid_empresa(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setdata(const Value: TDateTime);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setdocumento(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setparcela(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setdata_vencto(const Value: TDateTime);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Settaxa_juros(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setvl_total(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setvl_divida(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setjuros_pago(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setid_forma(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setavista(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setaprazo(const Value: WideString);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setobs(const Value: indefinido);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setid_movimento(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setid_cupons(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setid_pagamentos(const Value: Integer);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setvl_financeiro(const Value: Double);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setacredito(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setuniao(const Value: Boolean);  
begin    
  ativo:=value;  
end;  
procedure TFrm_ViewERPvenda.Setid_venda_uniao(const Value: Integer);  
begin    
  ativo:=value;  
end;  
end.
