...
object  Frm_ViewERPvendedor : TFrm_ViewERPvendedor
  Left = 0                                    
  Top = 0                                     
  Caption = 'ViewERPvendedor'
  ClientHeight = 507                          
  ClientWidth = 1034                          
  Color = clBtnFace                           
  ...
  object ScrollBox1: TScrollBox      
    ...
    TabOrder = 1                     
        ...
        object Edit_fantasia: TLabeledEdit       
          Left = 44              
          Top =  60              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_inicio_atividade: TLabeledEdit       
          Left = 54              
          Top =  70              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'inicio_atividade'
          TabOrder = 0                        
        end                                   
        object Edit_natureza_juridica: TLabeledEdit       
          Left = 64              
          Top =  80              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'natureza_juridica'
          TabOrder = 0                        
        end                                   
        object Edit_qualificacao_responsavel: TLabeledEdit       
          Left = 74              
          Top =  90              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'qualificacao_responsavel'
          TabOrder = 0                        
        end                                   
        object Edit_porte: TLabeledEdit       
          Left = 84              
          Top =  100              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_opcao_simples: TLabeledEdit       
          Left = 94              
          Top =  110              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'opcao_simples'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_telefones: TLabeledEdit       
          Left = 154              
          Top =  170              
          Width = 121                         
          Height = 21                         
        ...
        object Edit_qualificacao_socio1: TLabeledEdit       
          Left = 204              
          Top =  220              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'qualificacao_socio1'
          TabOrder = 0                        
        end                                   
        ...
        object Edit_qualificacao_socio2: TLabeledEdit       
          Left = 224              
          Top =  240              
          Width = 121                         
          Height = 21                         
          EditLabel.Width = 49                
          EditLabel.Height = 13               
          EditLabel.Caption = 'qualificacao_socio2'
          TabOrder = 0                        
        end                                   
